 ...
 * {@link com.br_automation.buoat.xddeditor.XDD.TLED} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class TLEDItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    protected void addLEDcolorsPropertyDescriptor(Object object) {
        itemPropertyDescriptors
            .add(createItemPropertyDescriptor(
                ...
                getString(
                    "_UI_PropertyDescriptor_description", "_UI_TLED_lEDcolors_feature",
                    "_UI_TLED_type"), XDDPackage.eINSTANCE.getTLED_LEDcolors(), true, false, false,
    ...
    protected void addLEDtypePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
            ...
            getString(
                "_UI_PropertyDescriptor_description", "_UI_TLED_lEDtype_feature", "_UI_TLED_type"),
            XDDPackage.eINSTANCE.getTLED_LEDtype(), true, false, false,
            ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    /**
     * This returns TLED.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    @Override
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_TLED_type")
    ...
    protected void
        ...
        newChildDescriptors.add(createChildParameter(
            ...
            FeatureMapUtil.createEntry(
                XDDPackage.eINSTANCE.getTLED_Label(), XDDFactory.eINSTANCE.createLabelType())));

        newChildDescriptors.add(createChildParameter(
            XDDPackage.eINSTANCE.getTLED_Group(), FeatureMapUtil.createEntry(
                XDDPackage.eINSTANCE.getTLED_Description(),
                XDDFactory.eINSTANCE.createDescriptionType())));

        newChildDescriptors
            .add(createChildParameter(XDDPackage.eINSTANCE.getTLED_Group(), FeatureMapUtil
                .createEntry(
        ...
        newChildDescriptors.add(createChildParameter(
            XDDPackage.eINSTANCE.getTLED_LEDstate(), XDDFactory.eINSTANCE.createLEDstateType()));
    }
