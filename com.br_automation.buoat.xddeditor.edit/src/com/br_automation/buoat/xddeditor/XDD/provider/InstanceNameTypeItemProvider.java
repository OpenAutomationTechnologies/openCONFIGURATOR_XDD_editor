...
/**
 * This is the item provider adapter for a {@link com.br_automation.buoat.xddeditor.XDD.InstanceNameType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InstanceNameTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_InstanceNameType_value_feature", "_UI_InstanceNameType_type"),
				 XDDPackage.eINSTANCE.getInstanceNameType_Value(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_InstanceNameType_readOnly_feature", "_UI_InstanceNameType_type"),
				 XDDPackage.eINSTANCE.getInstanceNameType_ReadOnly(),
				 true,
				 false,
				 false,
	...
	/**
	 * This returns InstanceNameType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_InstanceNameType_type") :
