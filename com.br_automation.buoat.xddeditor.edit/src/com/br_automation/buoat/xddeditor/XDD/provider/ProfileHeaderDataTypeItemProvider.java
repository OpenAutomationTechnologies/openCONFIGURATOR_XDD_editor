...
/**
 * This is the item provider adapter for a {@link com.br_automation.buoat.xddeditor.XDD.ProfileHeaderDataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProfileHeaderDataTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ProfileHeaderDataType_profileIdentification_feature", "_UI_ProfileHeaderDataType_type"),
				 XDDPackage.eINSTANCE.getProfileHeaderDataType_ProfileIdentification(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ProfileHeaderDataType_profileRevision_feature", "_UI_ProfileHeaderDataType_type"),
				 XDDPackage.eINSTANCE.getProfileHeaderDataType_ProfileRevision(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ProfileHeaderDataType_profileName_feature", "_UI_ProfileHeaderDataType_type"),
				 XDDPackage.eINSTANCE.getProfileHeaderDataType_ProfileName(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ProfileHeaderDataType_profileSource_feature", "_UI_ProfileHeaderDataType_type"),
				 XDDPackage.eINSTANCE.getProfileHeaderDataType_ProfileSource(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ProfileHeaderDataType_profileClassID_feature", "_UI_ProfileHeaderDataType_type"),
				 XDDPackage.eINSTANCE.getProfileHeaderDataType_ProfileClassID(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ProfileHeaderDataType_profileDate_feature", "_UI_ProfileHeaderDataType_type"),
				 XDDPackage.eINSTANCE.getProfileHeaderDataType_ProfileDate(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ProfileHeaderDataType_additionalInformation_feature", "_UI_ProfileHeaderDataType_type"),
				 XDDPackage.eINSTANCE.getProfileHeaderDataType_AdditionalInformation(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ProfileHeaderDataType_iASInterfaceType_feature", "_UI_ProfileHeaderDataType_type"),
				 XDDPackage.eINSTANCE.getProfileHeaderDataType_IASInterfaceType(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns ProfileHeaderDataType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ProfileHeaderDataType"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			...
			getString("_UI_ProfileHeaderDataType_type") + " " + label;
	}
