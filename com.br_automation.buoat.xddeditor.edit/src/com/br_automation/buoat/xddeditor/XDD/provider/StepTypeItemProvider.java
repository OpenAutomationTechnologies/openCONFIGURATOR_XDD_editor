...
/**
 * This is the item provider adapter for a {@link com.br_automation.buoat.xddeditor.XDD.StepType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_StepType_multiplier_feature", "_UI_StepType_type"),
				 XDDPackage.eINSTANCE.getStepType_Multiplier(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_StepType_offset_feature", "_UI_StepType_type"),
				 XDDPackage.eINSTANCE.getStepType_Offset(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_StepType_value_feature", "_UI_StepType_type"),
				 XDDPackage.eINSTANCE.getStepType_Value(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XDDPackage.eINSTANCE.getStepType_Group(),
				 FeatureMapUtil.createEntry
					(XDDPackage.eINSTANCE.getStepType_Label(),
