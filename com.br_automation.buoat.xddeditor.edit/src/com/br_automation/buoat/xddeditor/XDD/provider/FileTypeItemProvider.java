 ...
 * {@link com.br_automation.buoat.xddeditor.XDD.FileType} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class FileTypeItemProvider extends ItemProviderAdapter implements
    ...
    protected void addURIPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
            ...
            getResourceLocator(),
            getString("_UI_FileType_uRI_feature"),
            getString(
                "_UI_PropertyDescriptor_description", "_UI_FileType_uRI_feature",
                "_UI_FileType_type"), XDDPackage.eINSTANCE.getFileType_URI(), true, false, false,
            ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }

    /**
     * This returns FileType.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @generated
     */
    @Override
    ...
    public String getText(Object object) {
        String label = ((FileType) object).getURI();
        return label == null || label.length() == 0 ? getString("_UI_FileType_type")
