...
/**
 * This is the item provider adapter for a {@link com.br_automation.buoat.xddeditor.XDD.TRange} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TRangeItemProvider 
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XDDPackage.eINSTANCE.getTRange_MinValue(),
				 XDDFactory.eINSTANCE.createMinValueType()));

		newChildDescriptors.add
			(createChildParameter
				(XDDPackage.eINSTANCE.getTRange_MaxValue(),
				 XDDFactory.eINSTANCE.createMaxValueType()));

		newChildDescriptors.add
			(createChildParameter
				(XDDPackage.eINSTANCE.getTRange_Step(),
				 XDDFactory.eINSTANCE.createStepType()));
	}
