...
/**
 * This is the item provider adapter for a {@link com.br_automation.buoat.xddeditor.XDD.ProfileHandleDataType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProfileHandleDataTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ProfileHandleDataType_profileIdentification_feature", "_UI_ProfileHandleDataType_type"),
				 XDDPackage.eINSTANCE.getProfileHandleDataType_ProfileIdentification(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ProfileHandleDataType_profileRevision_feature", "_UI_ProfileHandleDataType_type"),
				 XDDPackage.eINSTANCE.getProfileHandleDataType_ProfileRevision(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ProfileHandleDataType_profileLocation_feature", "_UI_ProfileHandleDataType_type"),
				 XDDPackage.eINSTANCE.getProfileHandleDataType_ProfileLocation(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns ProfileHandleDataType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ProfileHandleDataType"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ProfileHandleDataType_type") :
