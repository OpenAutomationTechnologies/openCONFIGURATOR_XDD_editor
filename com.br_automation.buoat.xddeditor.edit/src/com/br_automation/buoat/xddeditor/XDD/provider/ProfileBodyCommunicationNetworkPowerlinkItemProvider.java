...
public class ProfileBodyCommunicationNetworkPowerlinkItemProvider extends
    ...
    public Object getImage(Object object) {
        return overlayImage(
            object,
            getResourceLocator().getImage("full/obj16/ProfileBodyCommunicationNetworkPowerlink"));
    }
    ...
    public String getCreateChildText(Object owner,
        ...
        boolean qualify = childFeature == XDDPackage.eINSTANCE
            .getProfileBodyCommunicationNetworkPowerlink_ApplicationLayers()
            || childFeature == XDDPackage.eINSTANCE
                .getProfileBodyCommunicationNetworkPowerlink_TransportLayers()
            || childFeature == XDDPackage.eINSTANCE
                .getProfileBodyCommunicationNetworkPowerlink_ExternalProfileHandle()
            || childFeature == XDDPackage.eINSTANCE
