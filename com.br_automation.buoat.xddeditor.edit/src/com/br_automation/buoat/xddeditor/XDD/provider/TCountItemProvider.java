...
/**
 * This is the item provider adapter for a {@link com.br_automation.buoat.xddeditor.XDD.TCount} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TCountItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 XDDPackage.eINSTANCE.getTCount_Access(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_TCount_uniqueID_feature", "_UI_TCount_type"),
				 XDDPackage.eINSTANCE.getTCount_UniqueID(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
			...
			(createChildParameter
				(XDDPackage.eINSTANCE.getTCount_Group(),
				 FeatureMapUtil.createEntry
					(XDDPackage.eINSTANCE.getTCount_Label(),
		...
		newChildDescriptors.add
			(createChildParameter
				(XDDPackage.eINSTANCE.getTCount_DefaultValue(),
