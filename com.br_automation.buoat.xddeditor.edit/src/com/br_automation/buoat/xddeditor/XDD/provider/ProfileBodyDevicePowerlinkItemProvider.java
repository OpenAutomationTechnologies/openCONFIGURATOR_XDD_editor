...
/**
 * This is the item provider adapter for a {@link com.br_automation.buoat.xddeditor.XDD.ProfileBodyDevicePowerlink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProfileBodyDevicePowerlinkItemProvider extends ProfileBodyDataTypeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ProfileBodyDevicePowerlink_deviceClass_feature", "_UI_ProfileBodyDevicePowerlink_type"),
				 XDDPackage.eINSTANCE.getProfileBodyDevicePowerlink_DeviceClass(),
				 true,
				 false,
				 false,
	...
	protected void addSpecificationVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ProfileBodyDevicePowerlink_specificationVersion_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ProfileBodyDevicePowerlink_specificationVersion_feature", "_UI_ProfileBodyDevicePowerlink_type"),
				 XDDPackage.eINSTANCE.getProfileBodyDevicePowerlink_SpecificationVersion(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XDDPackage.eINSTANCE.getProfileBodyDevicePowerlink_DeviceIdentity());
			childrenFeatures.add(XDDPackage.eINSTANCE.getProfileBodyDevicePowerlink_DeviceManager());
			childrenFeatures.add(XDDPackage.eINSTANCE.getProfileBodyDevicePowerlink_DeviceFunction());
			childrenFeatures.add(XDDPackage.eINSTANCE.getProfileBodyDevicePowerlink_ApplicationProcess());
			childrenFeatures.add(XDDPackage.eINSTANCE.getProfileBodyDevicePowerlink_ExternalProfileHandle());
		}
	...
	/**
	 * This returns ProfileBodyDevicePowerlink.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ProfileBodyDevicePowerlink"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ProfileBodyDevicePowerlink_type") :
