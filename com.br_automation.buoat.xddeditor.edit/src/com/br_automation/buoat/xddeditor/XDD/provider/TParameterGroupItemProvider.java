 ...
 * {@link com.br_automation.buoat.xddeditor.XDD.TParameterGroup} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class TParameterGroupItemProvider extends ItemProviderAdapter implements
    ...
    protected void addKindOfAccessPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
            ...
            getString(
                "_UI_PropertyDescriptor_description", "_UI_TParameterGroup_kindOfAccess_feature",
                "_UI_TParameterGroup_type"),
            XDDPackage.eINSTANCE.getTParameterGroup_KindOfAccess(), true, false, false,
    ...
    protected void addUniqueIDPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
            ...
            getString(
                "_UI_PropertyDescriptor_description", "_UI_TParameterGroup_uniqueID_feature",
                "_UI_TParameterGroup_type"), XDDPackage.eINSTANCE.getTParameterGroup_UniqueID(),
    ...
    /**
     * This returns TParameterGroup.gif. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
    ...
    public String getText(Object object) {
        String label = ((TParameterGroup) object).getKindOfAccess();
        return label == null || label.length() == 0 ? getString("_UI_TParameterGroup_type")
    ...
    protected void
        ...
        newChildDescriptors.add(createChildParameter(
            XDDPackage.eINSTANCE.getTParameterGroup_Group(), FeatureMapUtil.createEntry(
        ...
        newChildDescriptors.add(createChildParameter(XDDPackage.eINSTANCE
            .getTParameterGroup_Group(), FeatureMapUtil.createEntry(
