 ...
 * {@link com.br_automation.buoat.xddeditor.XDD.DescriptionType} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class DescriptionTypeItemProvider extends ItemProviderAdapter implements
    ...
    protected void addValuePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
            ...
            getString(
                "_UI_PropertyDescriptor_description", "_UI_DescriptionType_value_feature",
                "_UI_DescriptionType_type"), XDDPackage.eINSTANCE.getDescriptionType_Value(), true,
    ...
    protected void addLangPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
            ...
            getString(
                ...
                "_UI_DescriptionType_type"), XDDPackage.eINSTANCE.getDescriptionType_Lang(), true,
            false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }
    ...
    protected void addURIPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
            ((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
            getResourceLocator(),
            getString("_UI_DescriptionType_uRI_feature"),
            getString(
                "_UI_PropertyDescriptor_description", "_UI_DescriptionType_uRI_feature",
                "_UI_DescriptionType_type"), XDDPackage.eINSTANCE.getDescriptionType_URI(), true,
            false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
    }

    /**
     * This returns DescriptionType.gif. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @generated
     */
    ...
    public String getText(Object object) {
        ...
        return label == null || label.length() == 0 ? getString("_UI_DescriptionType_type")
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(DescriptionType.class)) {
            case XDDPackage.DESCRIPTION_TYPE__VALUE:
            case XDDPackage.DESCRIPTION_TYPE__LANG:
            case XDDPackage.DESCRIPTION_TYPE__URI:
