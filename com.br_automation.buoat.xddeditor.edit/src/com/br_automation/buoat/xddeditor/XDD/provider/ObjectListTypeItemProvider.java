...
/**
 * This is the item provider adapter for a {@link com.br_automation.buoat.xddeditor.XDD.ObjectListType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ObjectListTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ObjectListType_mandatoryObjects_feature", "_UI_ObjectListType_type"),
				 XDDPackage.eINSTANCE.getObjectListType_MandatoryObjects(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ObjectListType_manufacturerObjects_feature", "_UI_ObjectListType_type"),
				 XDDPackage.eINSTANCE.getObjectListType_ManufacturerObjects(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ObjectListType_optionalObjects_feature", "_UI_ObjectListType_type"),
				 XDDPackage.eINSTANCE.getObjectListType_OptionalObjects(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	/**
	 * This returns ObjectListType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XDDPackage.eINSTANCE.getObjectListType_Object(),
