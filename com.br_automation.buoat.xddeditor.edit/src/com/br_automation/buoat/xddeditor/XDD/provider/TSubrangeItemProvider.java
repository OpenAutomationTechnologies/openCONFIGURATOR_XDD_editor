...
/**
 * This is the item provider adapter for a {@link com.br_automation.buoat.xddeditor.XDD.TSubrange} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TSubrangeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_TSubrange_lowerLimit_feature", "_UI_TSubrange_type"),
				 XDDPackage.eINSTANCE.getTSubrange_LowerLimit(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_TSubrange_upperLimit_feature", "_UI_TSubrange_type"),
				 XDDPackage.eINSTANCE.getTSubrange_UpperLimit(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		BigInteger labelValue = ((TSubrange)object).getLowerLimit();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_TSubrange_type") :
			getString("_UI_TSubrange_type") + " " + label;
	}
