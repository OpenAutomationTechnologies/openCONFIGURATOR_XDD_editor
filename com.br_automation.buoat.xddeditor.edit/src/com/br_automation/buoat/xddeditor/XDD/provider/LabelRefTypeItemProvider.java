...
/**
 * This is the item provider adapter for a {@link com.br_automation.buoat.xddeditor.XDD.LabelRefType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LabelRefTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_LabelRefType_value_feature", "_UI_LabelRefType_type"),
				 XDDPackage.eINSTANCE.getLabelRefType_Value(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_LabelRefType_dictID_feature", "_UI_LabelRefType_type"),
				 XDDPackage.eINSTANCE.getLabelRefType_DictID(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_LabelRefType_textID_feature", "_UI_LabelRefType_type"),
				 XDDPackage.eINSTANCE.getLabelRefType_TextID(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_LabelRefType_type") :
