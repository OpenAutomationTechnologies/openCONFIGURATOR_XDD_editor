...
/**
 * This is the item provider adapter for a {@link com.br_automation.buoat.xddeditor.XDD.TAllowedValues} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TAllowedValuesItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_TAllowedValues_templateIDRef_feature", "_UI_TAllowedValues_type"),
				 XDDPackage.eINSTANCE.getTAllowedValues_TemplateIDRef(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XDDPackage.eINSTANCE.getTAllowedValues_Value());
			childrenFeatures.add(XDDPackage.eINSTANCE.getTAllowedValues_Range());
		}
	...
	/**
	 * This returns TAllowedValues.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TAllowedValues"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_TAllowedValues_type") :
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XDDPackage.eINSTANCE.getTAllowedValues_Value(),
				 XDDFactory.eINSTANCE.createTValue()));

		newChildDescriptors.add
			(createChildParameter
				(XDDPackage.eINSTANCE.getTAllowedValues_Range(),
