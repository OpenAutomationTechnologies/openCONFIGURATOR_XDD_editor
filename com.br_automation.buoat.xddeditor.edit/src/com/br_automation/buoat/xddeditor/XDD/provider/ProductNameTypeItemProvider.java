...
/**
 * This is the item provider adapter for a {@link com.br_automation.buoat.xddeditor.XDD.ProductNameType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProductNameTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ProductNameType_value_feature", "_UI_ProductNameType_type"),
				 XDDPackage.eINSTANCE.getProductNameType_Value(),
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ProductNameType_readOnly_feature", "_UI_ProductNameType_type"),
				 XDDPackage.eINSTANCE.getProductNameType_ReadOnly(),
				 true,
				 false,
				 false,
	...
	/**
	 * This returns ProductNameType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ProductNameType_type") :
