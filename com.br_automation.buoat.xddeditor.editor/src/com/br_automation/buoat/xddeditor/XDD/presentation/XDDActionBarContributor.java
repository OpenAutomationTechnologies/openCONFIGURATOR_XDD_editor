 ...
 * @generated
 */
public class XDDActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(XDDEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(XDDEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			@Override
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("xdd-settings"));
		toolBarManager.add(new Separator("xdd-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(XDDEditorPlugin.INSTANCE.getString("_UI_XDDEditor_menu"), "com.br_automation.buoat.xddeditor.ethernetMenuID");
