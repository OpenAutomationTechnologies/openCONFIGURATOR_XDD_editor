...
public class XDDValidator extends EObjectValidator {
     ...
     */
    public boolean
        validateCharacteristicContentType(CharacteristicContentType characteristicContentType,
            DiagnosticChain diagnostics,
            Map<Object, Object> context) {
     ...
     */
    public boolean
        validateISO15745ProfileContainerType(ISO15745ProfileContainerType iso15745ProfileContainerType,
            DiagnosticChain diagnostics,
            Map<Object, Object> context) {
     ...
     */
    public boolean
        validateISO15745ReferenceDataType(ISO15745ReferenceDataType iso15745ReferenceDataType,
            DiagnosticChain diagnostics,
            Map<Object, Object> context) {
     ...
     */
    public boolean
        validateProfileBodyDevicePowerlink(ProfileBodyDevicePowerlink profileBodyDevicePowerlink,
            DiagnosticChain diagnostics,
            Map<Object, Object> context) {
     ...
     */
    public boolean
        validateStandardComplianceListType(StandardComplianceListType standardComplianceListType,
            DiagnosticChain diagnostics,
            Map<Object, Object> context) {
     ...
     */
    public boolean
        validateTLED(TLED tled, DiagnosticChain diagnostics, Map<Object, Object> context) {
     ...
     */
    public boolean
        validateIASInterfaceDataTypeMember0(IASInterfaceDataTypeMember0 iasInterfaceDataTypeMember0,
            DiagnosticChain diagnostics,
            Map<Object, Object> context) {
        return true;
    }
     ...
     */
    public boolean
        validateIASInterfaceDataTypeMember0Object(IASInterfaceDataTypeMember0 iasInterfaceDataTypeMember0Object,
            DiagnosticChain diagnostics,
            Map<Object, Object> context) {
        return true;
    }
     ...
     */
    public boolean
        validateIASInterfaceDataTypeMember1_MinLength(String iasInterfaceDataTypeMember1,
            DiagnosticChain diagnostics,
            Map<Object, Object> context) {
     ...
     */
    public boolean
        validateIASInterfaceDataTypeMember1_MaxLength(String iasInterfaceDataTypeMember1,
            DiagnosticChain diagnostics,
            Map<Object, Object> context) {
        int length = iasInterfaceDataTypeMember1.length();
        boolean result = length <= 4;
     ...
     * @generated
     */
    public boolean validateOffsetType_Max(BigInteger offsetType,
        DiagnosticChain diagnostics,
        Map<Object, Object> context) {
     ...
     */
    public boolean
        validateProfileClassIDDataTypeObject(ProfileClassIDDataType profileClassIDDataTypeObject,
            DiagnosticChain diagnostics,
            Map<Object, Object> context) {
        return true;
    }
