...
public interface TApplicationProcess extends EObject {
    ...
    /**
     * Returns the value of the '<em><b>Function Type List</b></em>' containment
     * reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Function Type List</em>' containment reference
     * isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
     * @return the value of the '<em>Function Type List</em>' containment
     *         reference.
     ...
     * @model containment="true" extendedMetaData=
     *        "kind='element' name='functionTypeList' namespace='##targetNamespace'"
     * @generated
     */
     ...
     * 
     * @param value
     *            the new value of the '<em>Function Type List</em>' containment
     *            reference.
    ...
    /**
     * Returns the value of the '<em><b>Template List</b></em>' containment
     * reference. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc -->
     * 
     * This element contains a list of templates of parameters or allowed
     * values.
     * 
     * <!-- end-model-doc -->
     * 
     ...
     * @model containment="true" extendedMetaData=
     *        "kind='element' name='templateList' namespace='##targetNamespace'"
     * @generated
     */
     ...
     * 
     * @param value
     *            the new value of the '<em>Template List</em>' containment
     *            reference.
     * @see #getTemplateList()
     * @generated
     */
    ...
    /**
     * Returns the value of the '<em><b>Parameter List</b></em>' containment
     * reference. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
     * begin-model-doc -->
     * 
     ...
     *        "kind='element' name='parameterList' namespace='##targetNamespace'"
     * @generated
     */
     ...
     * 
     * @param value
     *            the new value of the '<em>Parameter List</em>' containment
     *            reference.
    ...
    /**
     * Returns the value of the '<em><b>Parameter Group List</b></em>'
     ...
     * <!-- end-model-doc -->
     * 
     * @return the value of the '<em>Parameter Group List</em>' containment
     *         reference.
     ...
     * @model containment="true" extendedMetaData=
     *        "kind='element' name='parameterGroupList' namespace='##targetNamespace'"
     * @generated
     */
     ...
     * 
     * @param value
     *            the new value of the '<em>Parameter Group List</em>'
     *            containment reference.
