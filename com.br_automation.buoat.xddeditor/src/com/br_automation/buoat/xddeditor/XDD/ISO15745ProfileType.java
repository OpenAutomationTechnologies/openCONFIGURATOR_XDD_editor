...
public interface ISO15745ProfileType extends EObject {
    /**
     * Returns the value of the '<em><b>Profile Header</b></em>' containment
     * reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Profile Header</em>' containment reference
     ...
     *        "kind='element' name='ProfileHeader' namespace='##targetNamespace'"
     * @generated
     */
     ...
     * 
     * @param value
     *            the new value of the '<em>Profile Header</em>' containment
     *            reference.
    ...
    /**
     * Returns the value of the '<em><b>Profile Body</b></em>' containment
     * reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Profile Body</em>' containment reference isn't
     ...
     * @model containment="true" required="true" extendedMetaData=
     *        "kind='element' name='ProfileBody' namespace='##targetNamespace'"
     * @generated
     */
     ...
     * Sets the value of the '
     * {@link com.br_automation.buoat.xddeditor.XDD.ISO15745ProfileType#getProfileBody
     * <em>Profile Body</em>}' containment reference. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
     * @param value
     *            the new value of the '<em>Profile Body</em>' containment
     *            reference.
     * @see #getProfileBody()
     * @generated
     */
