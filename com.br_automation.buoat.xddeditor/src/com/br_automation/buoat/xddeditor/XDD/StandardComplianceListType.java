 ...
 * @model 
 *        extendedMetaData="name='standardComplianceList_._type' kind='elementOnly'"
 * @generated
 */
public interface StandardComplianceListType extends EObject {
    /**
     * Returns the value of the '<em><b>Compliant With</b></em>' containment
     * reference list. The list contents are of type
     * {@link com.br_automation.buoat.xddeditor.XDD.CompliantWithType}. <!--
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Compliant With</em>' containment reference
     * list isn't clear, there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
     * @return the value of the '<em>Compliant With</em>' containment reference
     *         list.
     ...
     *        "kind='element' name='compliantWith' namespace='##targetNamespace'"
     * @generated
     */
