...
public enum AccessType implements Enumerator {
	...
	/**
	 * The '<em><b>Read Write Input</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>Read Write Input</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	...
	public static AccessType get(int value) {
		switch (value) {
			...
			case READ_WRITE_INPUT_VALUE: return READ_WRITE_INPUT;
