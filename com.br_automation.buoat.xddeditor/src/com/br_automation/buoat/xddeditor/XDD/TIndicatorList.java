 ...
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.TIndicatorList#getLEDList
 * <em>LED List</em>}</li>
 * </ul>
 * </p>
 * 
...
public interface TIndicatorList extends EObject {
    /**
     * Returns the value of the '<em><b>LED List</b></em>' containment
     * reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>LED List</em>' containment reference isn't
     ...
     *        "kind='element' name='LEDList' namespace='##targetNamespace'"
     * @generated
     */
     ...
     * <em>LED List</em>}' containment reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     * 
     * @param value
     *            the new value of the '<em>LED List</em>' containment
     *            reference.
     * @see #getLEDList()
     * @generated
     */
