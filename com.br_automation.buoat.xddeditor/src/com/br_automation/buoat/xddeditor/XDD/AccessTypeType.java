...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Access Type Type</b></em>',
...
public enum AccessTypeType implements Enumerator {
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>Read Write Output</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	private static final AccessTypeType[] VALUES_ARRAY =
		new AccessTypeType[] {
			READ_ONLY,
			WRITE_ONLY,
			READ_WRITE_OUTPUT,
	...
	/**
	 * A public read-only list of all the '<em><b>Access Type Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<AccessTypeType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Access Type Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the '<em><b>Access Type Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	...
	/**
	 * Returns the '<em><b>Access Type Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public static AccessTypeType get(int value) {
		switch (value) {
			...
			case READ_WRITE_OUTPUT_VALUE: return READ_WRITE_OUTPUT;
		}
		return null;
	}
	 ...
	 * @generated
	 */
	private AccessTypeType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
