 ...
 * <ul>
 * <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.LEDListTypeImpl#getLED
 * <em>LED</em>}</li>
 * <li>
 * {@link com.br_automation.buoat.xddeditor.XDD.impl.LEDListTypeImpl#getCombinedState
...
public class LEDListTypeImpl extends EObjectImpl implements LEDListType {
    /**
     * The cached value of the '{@link #getLED() <em>LED</em>}' containment
    ...
    /**
     * The cached value of the '{@link #getCombinedState()
     * <em>Combined State</em>}' containment reference list. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
    ...
    public EList<TCombinedState> getCombinedState() {
        if (combinedState == null) {
            combinedState = new EObjectContainmentEList<TCombinedState>(TCombinedState.class, this,
                XDDPackage.LED_LIST_TYPE__COMBINED_STATE);
        }
