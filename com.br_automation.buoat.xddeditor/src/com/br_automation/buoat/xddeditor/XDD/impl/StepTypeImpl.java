 ...
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.StepTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.StepTypeImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.StepTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.StepTypeImpl#getLabelRef <em>Label Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.StepTypeImpl#getDescriptionRef <em>Description Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.StepTypeImpl#getMultiplier <em>Multiplier</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.StepTypeImpl#getOffset <em>Offset</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.StepTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StepTypeImpl extends EObjectImpl implements StepType {
	...
	protected EClass eStaticClass() {
		return XDDPackage.eINSTANCE.getStepType();
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, XDDPackage.STEP_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<LabelType> getLabel() {
		return getGroup().list(XDDPackage.eINSTANCE.getStepType_Label());
	}
	...
	public EList<DescriptionType> getDescription() {
		return getGroup().list(XDDPackage.eINSTANCE.getStepType_Description());
	}
	...
	public EList<LabelRefType> getLabelRef() {
		return getGroup().list(XDDPackage.eINSTANCE.getStepType_LabelRef());
	}
	...
	public EList<DescriptionRefType> getDescriptionRef() {
		return getGroup().list(XDDPackage.eINSTANCE.getStepType_DescriptionRef());
	}
	...
	public void setMultiplier(String newMultiplier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.STEP_TYPE__MULTIPLIER, oldMultiplier, multiplier));
	}
