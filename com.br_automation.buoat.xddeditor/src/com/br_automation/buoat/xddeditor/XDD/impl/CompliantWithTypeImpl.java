...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Compliant With Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.CompliantWithTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.CompliantWithTypeImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.CompliantWithTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.CompliantWithTypeImpl#getLabelRef <em>Label Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.CompliantWithTypeImpl#getDescriptionRef <em>Description Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.CompliantWithTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.CompliantWithTypeImpl#getRange <em>Range</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompliantWithTypeImpl extends EObjectImpl implements CompliantWithType {
	...
	public void setRange(RangeType newRange) {
		...
		rangeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.COMPLIANT_WITH_TYPE__RANGE, oldRange, range, !oldRangeESet));
	}
	...
	public void unsetRange() {
		...
		rangeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.COMPLIANT_WITH_TYPE__RANGE, oldRange, RANGE_EDEFAULT, oldRangeESet));
	}
