...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TCapabilities</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TCapabilitiesImpl#getCharacteristicsList <em>Characteristics List</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TCapabilitiesImpl#getStandardComplianceList <em>Standard Compliance List</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TCapabilitiesImpl extends EObjectImpl implements TCapabilities {
	/**
	 * The cached value of the '{@link #getCharacteristicsList() <em>Characteristics List</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getStandardComplianceList() <em>Standard Compliance List</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<CharacteristicsListType> getCharacteristicsList() {
		if (characteristicsList == null) {
			characteristicsList = new EObjectContainmentEList<CharacteristicsListType>(CharacteristicsListType.class, this, XDDPackage.TCAPABILITIES__CHARACTERISTICS_LIST);
		}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetStandardComplianceList(StandardComplianceListType newStandardComplianceList, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.TCAPABILITIES__STANDARD_COMPLIANCE_LIST, oldStandardComplianceList, newStandardComplianceList);
	...
	public void setStandardComplianceList(StandardComplianceListType newStandardComplianceList) {
		if (newStandardComplianceList != standardComplianceList) {
			...
			if (standardComplianceList != null)
				msgs = ((InternalEObject)standardComplianceList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TCAPABILITIES__STANDARD_COMPLIANCE_LIST, null, msgs);
			if (newStandardComplianceList != null)
				msgs = ((InternalEObject)newStandardComplianceList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TCAPABILITIES__STANDARD_COMPLIANCE_LIST, null, msgs);
			msgs = basicSetStandardComplianceList(newStandardComplianceList, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TCAPABILITIES__STANDARD_COMPLIANCE_LIST, newStandardComplianceList, newStandardComplianceList));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case XDDPackage.TCAPABILITIES__CHARACTERISTICS_LIST:
				...
				getCharacteristicsList().addAll((Collection<? extends CharacteristicsListType>)newValue);
				return;
			case XDDPackage.TCAPABILITIES__STANDARD_COMPLIANCE_LIST:
