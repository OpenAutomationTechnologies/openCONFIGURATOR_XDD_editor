 ...
 * <ul>
 * <li>
 * {@link com.br_automation.buoat.xddeditor.XDD.impl.TAllowedValuesImpl#getValue
 * <em>Value</em>}</li>
 * <li>
 * {@link com.br_automation.buoat.xddeditor.XDD.impl.TAllowedValuesImpl#getRange
 * <em>Range</em>}</li>
 * <li>
 * {@link com.br_automation.buoat.xddeditor.XDD.impl.TAllowedValuesImpl#getTemplateIDRef
    ...
    public EList<TValue> getValue() {
        if (value == null) {
            value = new EObjectContainmentEList<TValue>(TValue.class, this,
                XDDPackage.TALLOWED_VALUES__VALUE);
        }
        return value;
    }
    ...
    public EList<TRange> getRange() {
        if (range == null) {
            range = new EObjectContainmentEList<TRange>(TRange.class, this,
                XDDPackage.TALLOWED_VALUES__RANGE);
        }
        return range;
    }
    ...
    public void setTemplateIDRef(String newTemplateIDRef) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                XDDPackage.TALLOWED_VALUES__TEMPLATE_ID_REF, oldTemplateIDRef, templateIDRef));
    }
