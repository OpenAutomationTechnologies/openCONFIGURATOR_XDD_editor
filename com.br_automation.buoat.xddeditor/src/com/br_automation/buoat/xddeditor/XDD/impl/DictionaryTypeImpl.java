 ...
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.DictionaryTypeImpl#getFile <em>File</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.DictionaryTypeImpl#getDictID <em>Dict ID</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.DictionaryTypeImpl#getLang <em>Lang</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DictionaryTypeImpl extends EObjectImpl implements DictionaryType {
	...
	/**
	 * The default value of the '{@link #getDictID() <em>Dict ID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getDictID()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getDictID() <em>Dict ID</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getDictID()
	 * @generated
	...
	public NotificationChain basicSetFile(FileType newFile, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.DICTIONARY_TYPE__FILE, oldFile, newFile);
	...
	public void setFile(FileType newFile) {
		if (newFile != file) {
			...
			if (file != null)
				msgs = ((InternalEObject)file).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDDPackage.DICTIONARY_TYPE__FILE, null, msgs);
			if (newFile != null)
				msgs = ((InternalEObject)newFile).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDDPackage.DICTIONARY_TYPE__FILE, null, msgs);
	...
	public void setDictID(String newDictID) {
		...
		dictID = newDictID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.DICTIONARY_TYPE__DICT_ID, oldDictID, dictID));
	}
