...
public class XDDFactoryImpl extends EFactoryImpl implements XDDFactory {
    ...
    public EObject create(EClass eClass) {
        ...
        case XDDPackage.TCLASSIFICATION_LIST:
            return createTClassificationList();
     ...
     * @generated
     */
    public IASInterfaceDataTypeMember0 createIASInterfaceDataTypeMember0FromString(EDataType eDataType,
            String initialValue) {
    ...
    public Object createIASInterfaceDataTypeFromString(EDataType eDataType, String initialValue) {
        ...
        try {
            result = createIASInterfaceDataTypeMember0FromString(XDDPackage.eINSTANCE.getIASInterfaceDataTypeMember0(),
                    initialValue);
        ...
        try {
            result = createIASInterfaceDataTypeMember1FromString(XDDPackage.eINSTANCE.getIASInterfaceDataTypeMember1(),
                    initialValue);
            if (result != null && Diagnostician.INSTANCE.validate(eDataType, result, null, null)) {
                return result;
            }
     ...
     * @generated
     */
    public IASInterfaceDataTypeMember0 createIASInterfaceDataTypeMember0ObjectFromString(EDataType eDataType,
            String initialValue) {
        return createIASInterfaceDataTypeMember0FromString(XDDPackage.eINSTANCE.getIASInterfaceDataTypeMember0(),
                initialValue);
    }
    ...
    public String convertIASInterfaceDataTypeMember0ObjectToString(EDataType eDataType, Object instanceValue) {
        return convertIASInterfaceDataTypeMember0ToString(XDDPackage.eINSTANCE.getIASInterfaceDataTypeMember0(),
                instanceValue);
    }
