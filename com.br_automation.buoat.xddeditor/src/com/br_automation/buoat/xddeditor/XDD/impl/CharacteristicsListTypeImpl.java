...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Characteristics List Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.CharacteristicsListTypeImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.CharacteristicsListTypeImpl#getCharacteristic <em>Characteristic</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CharacteristicsListTypeImpl extends EObjectImpl implements CharacteristicsListType {
	...
	public NotificationChain basicSetCategory(CategoryType newCategory, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.CHARACTERISTICS_LIST_TYPE__CATEGORY, oldCategory, newCategory);
	...
	public void setCategory(CategoryType newCategory) {
		if (newCategory != category) {
			...
			if (category != null)
				msgs = ((InternalEObject)category).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDDPackage.CHARACTERISTICS_LIST_TYPE__CATEGORY, null, msgs);
			if (newCategory != null)
				msgs = ((InternalEObject)newCategory).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDDPackage.CHARACTERISTICS_LIST_TYPE__CATEGORY, null, msgs);
			msgs = basicSetCategory(newCategory, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.CHARACTERISTICS_LIST_TYPE__CATEGORY, newCategory, newCategory));
	}
	...
	public EList<CharacteristicType> getCharacteristic() {
		if (characteristic == null) {
			characteristic = new EObjectContainmentEList<CharacteristicType>(CharacteristicType.class, this, XDDPackage.CHARACTERISTICS_LIST_TYPE__CHARACTERISTIC);
		}
