...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Product Text Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProductTextTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProductTextTypeImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProductTextTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProductTextTypeImpl#getLabelRef <em>Label Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProductTextTypeImpl#getDescriptionRef <em>Description Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProductTextTypeImpl#isReadOnly <em>Read Only</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProductTextTypeImpl extends EObjectImpl implements ProductTextType {
	...
	protected EClass eStaticClass() {
		return XDDPackage.eINSTANCE.getProductTextType();
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, XDDPackage.PRODUCT_TEXT_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<LabelType> getLabel() {
		return getGroup().list(XDDPackage.eINSTANCE.getProductTextType_Label());
	}
	...
	public EList<DescriptionType> getDescription() {
		return getGroup().list(XDDPackage.eINSTANCE.getProductTextType_Description());
	}
	...
	public EList<LabelRefType> getLabelRef() {
		return getGroup().list(XDDPackage.eINSTANCE.getProductTextType_LabelRef());
	}
	...
	public EList<DescriptionRefType> getDescriptionRef() {
		return getGroup().list(XDDPackage.eINSTANCE.getProductTextType_DescriptionRef());
	}
	...
	public void setReadOnly(boolean newReadOnly) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.PRODUCT_TEXT_TYPE__READ_ONLY, oldReadOnly, readOnly, !oldReadOnlyESet));
	}
	...
	public void unsetReadOnly() {
		...
		readOnlyESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.PRODUCT_TEXT_TYPE__READ_ONLY, oldReadOnly, READ_ONLY_EDEFAULT, oldReadOnlyESet));
	}
