...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Profile Handle Data Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProfileHandleDataTypeImpl#getProfileIdentification <em>Profile Identification</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProfileHandleDataTypeImpl#getProfileRevision <em>Profile Revision</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProfileHandleDataTypeImpl#getProfileLocation <em>Profile Location</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProfileHandleDataTypeImpl extends EObjectImpl implements ProfileHandleDataType {
	...
	public void setProfileIdentification(String newProfileIdentification) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.PROFILE_HANDLE_DATA_TYPE__PROFILE_IDENTIFICATION, oldProfileIdentification, profileIdentification));
	}
	...
	public void setProfileRevision(String newProfileRevision) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.PROFILE_HANDLE_DATA_TYPE__PROFILE_REVISION, oldProfileRevision, profileRevision));
	}
	...
	public void setProfileLocation(String newProfileLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.PROFILE_HANDLE_DATA_TYPE__PROFILE_LOCATION, oldProfileLocation, profileLocation));
	}
