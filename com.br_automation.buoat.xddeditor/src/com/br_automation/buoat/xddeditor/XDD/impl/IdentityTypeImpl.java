 ...
 * <ul>
 * <li>
 * {@link com.br_automation.buoat.xddeditor.XDD.impl.IdentityTypeImpl#getVendorID
 * <em>Vendor ID</em>}</li>
 * <li>
 * {@link com.br_automation.buoat.xddeditor.XDD.impl.IdentityTypeImpl#getDeviceFamily
 * <em>Device Family</em>}</li>
 * <li>
 * {@link com.br_automation.buoat.xddeditor.XDD.impl.IdentityTypeImpl#getProductID
 * <em>Product ID</em>}</li>
 * <li>
 * {@link com.br_automation.buoat.xddeditor.XDD.impl.IdentityTypeImpl#getVersion
 * <em>Version</em>}</li>
 * <li>
 * {@link com.br_automation.buoat.xddeditor.XDD.impl.IdentityTypeImpl#getBuildDate
 * <em>Build Date</em>}</li>
 * <li>
 * {@link com.br_automation.buoat.xddeditor.XDD.impl.IdentityTypeImpl#getSpecificationRevision
...
public class IdentityTypeImpl extends EObjectImpl implements IdentityType {
    ...
    public NotificationChain basicSetVendorID(TVendorID newVendorID, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                XDDPackage.IDENTITY_TYPE__VENDOR_ID, oldVendorID, newVendorID);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newVendorID != vendorID) {
            ...
            if (vendorID != null)
                msgs = ((InternalEObject) vendorID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                    - XDDPackage.IDENTITY_TYPE__VENDOR_ID, null, msgs);
            if (newVendorID != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                XDDPackage.IDENTITY_TYPE__VENDOR_ID, newVendorID, newVendorID));
    }
    ...
    public NotificationChain basicSetDeviceFamily(TDeviceFamily newDeviceFamily,
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                XDDPackage.IDENTITY_TYPE__DEVICE_FAMILY, oldDeviceFamily, newDeviceFamily);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newDeviceFamily != deviceFamily) {
            ...
            if (deviceFamily != null)
                msgs = ((InternalEObject) deviceFamily).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                    - XDDPackage.IDENTITY_TYPE__DEVICE_FAMILY, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                XDDPackage.IDENTITY_TYPE__DEVICE_FAMILY, newDeviceFamily, newDeviceFamily));
    }
    ...
    public NotificationChain basicSetProductID(TProductID newProductID, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                XDDPackage.IDENTITY_TYPE__PRODUCT_ID, oldProductID, newProductID);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newProductID != productID) {
            ...
            if (productID != null)
                msgs = ((InternalEObject) productID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                    - XDDPackage.IDENTITY_TYPE__PRODUCT_ID, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                XDDPackage.IDENTITY_TYPE__PRODUCT_ID, newProductID, newProductID));
    }
    ...
    public EList<TVersion> getVersion() {
        if (version == null) {
            version = new EObjectContainmentEList<TVersion>(TVersion.class, this,
                XDDPackage.IDENTITY_TYPE__VERSION);
        }
        return version;
    }
    ...
    public void setBuildDate(XMLGregorianCalendar newBuildDate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                XDDPackage.IDENTITY_TYPE__BUILD_DATE, oldBuildDate, buildDate));
    }
    ...
    public NotificationChain
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                XDDPackage.IDENTITY_TYPE__SPECIFICATION_REVISION, oldSpecificationRevision,
        ...
        if (newSpecificationRevision != specificationRevision) {
            ...
            if (specificationRevision != null)
                msgs = ((InternalEObject) specificationRevision).eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - XDDPackage.IDENTITY_TYPE__SPECIFICATION_REVISION,
                    null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                XDDPackage.IDENTITY_TYPE__SPECIFICATION_REVISION, newSpecificationRevision,
                newSpecificationRevision));
    }
