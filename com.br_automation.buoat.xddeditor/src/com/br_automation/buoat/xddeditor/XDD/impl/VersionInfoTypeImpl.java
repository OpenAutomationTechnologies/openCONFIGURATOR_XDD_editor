 ...
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.VersionInfoTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.VersionInfoTypeImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.VersionInfoTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.VersionInfoTypeImpl#getLabelRef <em>Label Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.VersionInfoTypeImpl#getDescriptionRef <em>Description Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.VersionInfoTypeImpl#getAuthor <em>Author</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.VersionInfoTypeImpl#getDate <em>Date</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.VersionInfoTypeImpl#getOrganization <em>Organization</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.VersionInfoTypeImpl#getVersion <em>Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VersionInfoTypeImpl extends EObjectImpl implements VersionInfoType {
	...
	public void setAuthor(String newAuthor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.VERSION_INFO_TYPE__AUTHOR, oldAuthor, author));
	}
	...
	public void setDate(XMLGregorianCalendar newDate) {
		...
		date = newDate;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.VERSION_INFO_TYPE__DATE, oldDate, date));
	}
	...
	public void setOrganization(String newOrganization) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.VERSION_INFO_TYPE__ORGANIZATION, oldOrganization, organization));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.VERSION_INFO_TYPE__VERSION, oldVersion, version));
	}
