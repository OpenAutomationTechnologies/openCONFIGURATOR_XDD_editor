...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TObject</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TObjectImpl#getSubObject <em>Sub Object</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TObjectImpl#getAccessType <em>Access Type</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TObjectImpl#getActualValue <em>Actual Value</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TObjectImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TObjectImpl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TObjectImpl#getDenotation <em>Denotation</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TObjectImpl#getHighLimit <em>High Limit</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TObjectImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TObjectImpl#getLowLimit <em>Low Limit</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TObjectImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TObjectImpl#getObjectType <em>Object Type</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TObjectImpl#getObjFlags <em>Obj Flags</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TObjectImpl#getPDOmapping <em>PD Omapping</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TObjectImpl#getSubNumber <em>Sub Number</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TObjectImpl#getUniqueIDRef <em>Unique ID Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TObjectImpl extends EObjectImpl implements TObject {
	/**
	 * The cached value of the '{@link #getSubObject() <em>Sub Object</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getSubObject()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getDenotation() <em>Denotation</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getDenotation()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getDenotation() <em>Denotation</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getDenotation()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getObjFlags() <em>Obj Flags</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getObjFlags()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getObjFlags() <em>Obj Flags</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getObjFlags()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getPDOmapping() <em>PD Omapping</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getPDOmapping()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getPDOmapping() <em>PD Omapping</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getPDOmapping()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getSubNumber() <em>Sub Number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getSubNumber()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getSubNumber() <em>Sub Number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getSubNumber()
	 * @generated
	...
	public EList<SubObjectType> getSubObject() {
		if (subObject == null) {
			subObject = new EObjectContainmentEList<SubObjectType>(SubObjectType.class, this, XDDPackage.TOBJECT__SUB_OBJECT);
		}
		return subObject;
	}
	...
	public void setAccessType(TObjectAccessType newAccessType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TOBJECT__ACCESS_TYPE, oldAccessType, accessType, !oldAccessTypeESet));
	}
	...
	public void unsetAccessType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TOBJECT__ACCESS_TYPE, oldAccessType, ACCESS_TYPE_EDEFAULT, oldAccessTypeESet));
	}
	...
	public void setActualValue(String newActualValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TOBJECT__ACTUAL_VALUE, oldActualValue, actualValue));
	}
	...
	public void setDataType(byte[] newDataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TOBJECT__DATA_TYPE, oldDataType, dataType));
	}
	...
	public void setDefaultValue(String newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TOBJECT__DEFAULT_VALUE, oldDefaultValue, defaultValue));
	}
	...
	public void setDenotation(String newDenotation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TOBJECT__DENOTATION, oldDenotation, denotation));
	}
	...
	public void setHighLimit(String newHighLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TOBJECT__HIGH_LIMIT, oldHighLimit, highLimit));
	}
	...
	public void setLowLimit(String newLowLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TOBJECT__LOW_LIMIT, oldLowLimit, lowLimit));
	}
	...
	public void setObjectType(short newObjectType) {
		...
		objectTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TOBJECT__OBJECT_TYPE, oldObjectType, objectType, !oldObjectTypeESet));
	}
	...
	public void unsetObjectType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TOBJECT__OBJECT_TYPE, oldObjectType, OBJECT_TYPE_EDEFAULT, oldObjectTypeESet));
	}
	...
	public void setObjFlags(byte[] newObjFlags) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TOBJECT__OBJ_FLAGS, oldObjFlags, objFlags));
	}
	...
	public void setPDOmapping(TObjectPDOMapping newPDOmapping) {
		...
		pDOmappingESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TOBJECT__PD_OMAPPING, oldPDOmapping, pDOmapping, !oldPDOmappingESet));
	}
	...
	public void unsetPDOmapping() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TOBJECT__PD_OMAPPING, oldPDOmapping, PD_OMAPPING_EDEFAULT, oldPDOmappingESet));
	}
	...
	public void setSubNumber(short newSubNumber) {
		...
		subNumberESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TOBJECT__SUB_NUMBER, oldSubNumber, subNumber, !oldSubNumberESet));
	}
	...
	public void unsetSubNumber() {
		...
		subNumberESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TOBJECT__SUB_NUMBER, oldSubNumber, SUB_NUMBER_EDEFAULT, oldSubNumberESet));
	}
	...
	public void setUniqueIDRef(String newUniqueIDRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TOBJECT__UNIQUE_ID_REF, oldUniqueIDRef, uniqueIDRef));
	}
	...
	public String toString() {
		...
		if (pDOmappingESet) result.append(pDOmapping); else result.append("<unset>");
		result.append(", subNumber: ");
		if (subNumberESet) result.append(subNumber); else result.append("<unset>");
