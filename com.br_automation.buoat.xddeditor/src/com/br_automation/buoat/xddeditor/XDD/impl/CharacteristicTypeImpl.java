 ...
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.CharacteristicTypeImpl#getCharacteristicName <em>Characteristic Name</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.CharacteristicTypeImpl#getCharacteristicContent <em>Characteristic Content</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CharacteristicTypeImpl extends EObjectImpl implements CharacteristicType {
	/**
	 * The cached value of the '{@link #getCharacteristicName() <em>Characteristic Name</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getCharacteristicContent() <em>Characteristic Content</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCharacteristicName(CharacteristicNameType newCharacteristicName, NotificationChain msgs) {
		CharacteristicNameType oldCharacteristicName = characteristicName;
		characteristicName = newCharacteristicName;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.CHARACTERISTIC_TYPE__CHARACTERISTIC_NAME, oldCharacteristicName, newCharacteristicName);
	...
	public void setCharacteristicName(CharacteristicNameType newCharacteristicName) {
		if (newCharacteristicName != characteristicName) {
			...
			if (characteristicName != null)
				msgs = ((InternalEObject)characteristicName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDDPackage.CHARACTERISTIC_TYPE__CHARACTERISTIC_NAME, null, msgs);
			if (newCharacteristicName != null)
				msgs = ((InternalEObject)newCharacteristicName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDDPackage.CHARACTERISTIC_TYPE__CHARACTERISTIC_NAME, null, msgs);
			msgs = basicSetCharacteristicName(newCharacteristicName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.CHARACTERISTIC_TYPE__CHARACTERISTIC_NAME, newCharacteristicName, newCharacteristicName));
	}
	...
	public EList<CharacteristicContentType> getCharacteristicContent() {
		if (characteristicContent == null) {
			characteristicContent = new EObjectContainmentEList<CharacteristicContentType>(CharacteristicContentType.class, this, XDDPackage.CHARACTERISTIC_TYPE__CHARACTERISTIC_CONTENT);
		}
