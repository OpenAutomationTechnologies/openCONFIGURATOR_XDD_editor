...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TCount</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TCountImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TCountImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TCountImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TCountImpl#getLabelRef <em>Label Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TCountImpl#getDescriptionRef <em>Description Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TCountImpl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TCountImpl#getAllowedValues <em>Allowed Values</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TCountImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TCountImpl#getUniqueID <em>Unique ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TCountImpl extends EObjectImpl implements TCount {
	...
	public NotificationChain basicSetDefaultValue(TValue newDefaultValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.TCOUNT__DEFAULT_VALUE, oldDefaultValue, newDefaultValue);
	...
	public void setDefaultValue(TValue newDefaultValue) {
		if (newDefaultValue != defaultValue) {
			...
			if (defaultValue != null)
				msgs = ((InternalEObject)defaultValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TCOUNT__DEFAULT_VALUE, null, msgs);
			if (newDefaultValue != null)
				msgs = ((InternalEObject)newDefaultValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TCOUNT__DEFAULT_VALUE, null, msgs);
			msgs = basicSetDefaultValue(newDefaultValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TCOUNT__DEFAULT_VALUE, newDefaultValue, newDefaultValue));
	}
	...
	public NotificationChain basicSetAllowedValues(TAllowedValues newAllowedValues, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.TCOUNT__ALLOWED_VALUES, oldAllowedValues, newAllowedValues);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAllowedValues(TAllowedValues newAllowedValues) {
		if (newAllowedValues != allowedValues) {
			...
			if (allowedValues != null)
				msgs = ((InternalEObject)allowedValues).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TCOUNT__ALLOWED_VALUES, null, msgs);
			if (newAllowedValues != null)
				msgs = ((InternalEObject)newAllowedValues).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TCOUNT__ALLOWED_VALUES, null, msgs);
			msgs = basicSetAllowedValues(newAllowedValues, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TCOUNT__ALLOWED_VALUES, newAllowedValues, newAllowedValues));
	}
	...
	public void setAccess(AccessType1 newAccess) {
		...
		accessESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TCOUNT__ACCESS, oldAccess, access, !oldAccessESet));
	}
	...
	public void unsetAccess() {
		...
		accessESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TCOUNT__ACCESS, oldAccess, ACCESS_EDEFAULT, oldAccessESet));
	}
