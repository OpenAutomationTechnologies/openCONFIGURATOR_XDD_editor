...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Function Type Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FunctionTypeTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FunctionTypeTypeImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FunctionTypeTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FunctionTypeTypeImpl#getLabelRef <em>Label Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FunctionTypeTypeImpl#getDescriptionRef <em>Description Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FunctionTypeTypeImpl#getVersionInfo <em>Version Info</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FunctionTypeTypeImpl#getInterfaceList <em>Interface List</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FunctionTypeTypeImpl#getFunctionInstanceList <em>Function Instance List</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FunctionTypeTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FunctionTypeTypeImpl#getPackage <em>Package</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FunctionTypeTypeImpl#getUniqueID <em>Unique ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionTypeTypeImpl extends EObjectImpl implements FunctionTypeType {
	...
	public EList<VersionInfoType> getVersionInfo() {
		if (versionInfo == null) {
			versionInfo = new EObjectContainmentEList<VersionInfoType>(VersionInfoType.class, this, XDDPackage.FUNCTION_TYPE_TYPE__VERSION_INFO);
		}
		return versionInfo;
	}
	...
	public NotificationChain basicSetInterfaceList(InterfaceListType newInterfaceList, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.FUNCTION_TYPE_TYPE__INTERFACE_LIST, oldInterfaceList, newInterfaceList);
	...
	public void setInterfaceList(InterfaceListType newInterfaceList) {
		if (newInterfaceList != interfaceList) {
			...
			if (interfaceList != null)
				msgs = ((InternalEObject)interfaceList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDDPackage.FUNCTION_TYPE_TYPE__INTERFACE_LIST, null, msgs);
			if (newInterfaceList != null)
				msgs = ((InternalEObject)newInterfaceList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDDPackage.FUNCTION_TYPE_TYPE__INTERFACE_LIST, null, msgs);
			msgs = basicSetInterfaceList(newInterfaceList, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.FUNCTION_TYPE_TYPE__INTERFACE_LIST, newInterfaceList, newInterfaceList));
	}
	...
	public NotificationChain basicSetFunctionInstanceList(TFunctionInstanceList newFunctionInstanceList, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.FUNCTION_TYPE_TYPE__FUNCTION_INSTANCE_LIST, oldFunctionInstanceList, newFunctionInstanceList);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setFunctionInstanceList(TFunctionInstanceList newFunctionInstanceList) {
		if (newFunctionInstanceList != functionInstanceList) {
			...
			if (functionInstanceList != null)
				msgs = ((InternalEObject)functionInstanceList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDDPackage.FUNCTION_TYPE_TYPE__FUNCTION_INSTANCE_LIST, null, msgs);
			if (newFunctionInstanceList != null)
				msgs = ((InternalEObject)newFunctionInstanceList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDDPackage.FUNCTION_TYPE_TYPE__FUNCTION_INSTANCE_LIST, null, msgs);
			msgs = basicSetFunctionInstanceList(newFunctionInstanceList, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.FUNCTION_TYPE_TYPE__FUNCTION_INSTANCE_LIST, newFunctionInstanceList, newFunctionInstanceList));
	}
	...
	public void setPackage(String newPackage) {
		...
		package_ = newPackage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.FUNCTION_TYPE_TYPE__PACKAGE, oldPackage, package_));
	}
	...
	public void setUniqueID(String newUniqueID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.FUNCTION_TYPE_TYPE__UNIQUE_ID, oldUniqueID, uniqueID));
	}
