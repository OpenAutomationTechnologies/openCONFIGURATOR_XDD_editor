 ...
 * <ul>
 * <li>
 * {@link com.br_automation.buoat.xddeditor.XDD.impl.TTemplateListImpl#getParameterTemplate
 * <em>Parameter Template</em>}</li>
 * <li>
 * {@link com.br_automation.buoat.xddeditor.XDD.impl.TTemplateListImpl#getAllowedValuesTemplate
...
public class TTemplateListImpl extends EObjectImpl implements TTemplateList {
    /**
     * The cached value of the '{@link #getParameterTemplate()
     * <em>Parameter Template</em>}' containment reference list. <!--
    ...
    /**
     * The cached value of the '{@link #getAllowedValuesTemplate()
     * <em>Allowed Values Template</em>}' containment reference list. <!--
     * begin-user-doc --> <!-- end-user-doc -->
     * 
    ...
    public EList<TParameterTemplate> getParameterTemplate() {
        if (parameterTemplate == null) {
            parameterTemplate = new EObjectContainmentEList<TParameterTemplate>(
                TParameterTemplate.class, this, XDDPackage.TTEMPLATE_LIST__PARAMETER_TEMPLATE);
        }
    ...
    public EList<TAllowedValuesTemplate> getAllowedValuesTemplate() {
        if (allowedValuesTemplate == null) {
            allowedValuesTemplate = new EObjectContainmentEList<TAllowedValuesTemplate>(
                TAllowedValuesTemplate.class, this,
                XDDPackage.TTEMPLATE_LIST__ALLOWED_VALUES_TEMPLATE);
        }
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            ...
            case XDDPackage.TTEMPLATE_LIST__ALLOWED_VALUES_TEMPLATE:
                ...
                getAllowedValuesTemplate().addAll(
                    (Collection<? extends TAllowedValuesTemplate>) newValue);
                return;
        }
