...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TDynamic Channel</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDynamicChannelImpl#getAccessType <em>Access Type</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDynamicChannelImpl#getAddressOffset <em>Address Offset</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDynamicChannelImpl#getBitAlignment <em>Bit Alignment</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDynamicChannelImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDynamicChannelImpl#getEndIndex <em>End Index</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDynamicChannelImpl#getMaxNumber <em>Max Number</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDynamicChannelImpl#getStartIndex <em>Start Index</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TDynamicChannelImpl extends EObjectImpl implements TDynamicChannel {
	...
	/**
	 * The default value of the '{@link #getBitAlignment() <em>Bit Alignment</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getBitAlignment()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getBitAlignment() <em>Bit Alignment</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getBitAlignment()
	 * @generated
	...
	public void setAccessType(AccessTypeType newAccessType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDYNAMIC_CHANNEL__ACCESS_TYPE, oldAccessType, accessType, !oldAccessTypeESet));
	}
	...
	public void unsetAccessType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TDYNAMIC_CHANNEL__ACCESS_TYPE, oldAccessType, ACCESS_TYPE_EDEFAULT, oldAccessTypeESet));
	}
	...
	public void setAddressOffset(byte[] newAddressOffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDYNAMIC_CHANNEL__ADDRESS_OFFSET, oldAddressOffset, addressOffset));
	}
	...
	public void setBitAlignment(short newBitAlignment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDYNAMIC_CHANNEL__BIT_ALIGNMENT, oldBitAlignment, bitAlignment, !oldBitAlignmentESet));
	}
	...
	public void unsetBitAlignment() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TDYNAMIC_CHANNEL__BIT_ALIGNMENT, oldBitAlignment, BIT_ALIGNMENT_EDEFAULT, oldBitAlignmentESet));
	}
	...
	public void setDataType(byte[] newDataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDYNAMIC_CHANNEL__DATA_TYPE, oldDataType, dataType));
	}
	...
	public void setEndIndex(byte[] newEndIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDYNAMIC_CHANNEL__END_INDEX, oldEndIndex, endIndex));
	}
	...
	public void setMaxNumber(long newMaxNumber) {
		...
		maxNumberESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDYNAMIC_CHANNEL__MAX_NUMBER, oldMaxNumber, maxNumber, !oldMaxNumberESet));
	}
	...
	public void unsetMaxNumber() {
		...
		maxNumberESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TDYNAMIC_CHANNEL__MAX_NUMBER, oldMaxNumber, MAX_NUMBER_EDEFAULT, oldMaxNumberESet));
	}
	...
	public void setStartIndex(byte[] newStartIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDYNAMIC_CHANNEL__START_INDEX, oldStartIndex, startIndex));
	}
	...
	public String toString() {
		...
		if (bitAlignmentESet) result.append(bitAlignment); else result.append("<unset>");
		result.append(", dataType: ");
		result.append(dataType);
		result.append(", endIndex: ");
		result.append(endIndex);
		result.append(", maxNumber: ");
		if (maxNumberESet) result.append(maxNumber); else result.append("<unset>");
