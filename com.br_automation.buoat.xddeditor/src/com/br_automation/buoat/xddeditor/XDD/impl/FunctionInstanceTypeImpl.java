...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Function Instance Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FunctionInstanceTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FunctionInstanceTypeImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FunctionInstanceTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FunctionInstanceTypeImpl#getLabelRef <em>Label Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FunctionInstanceTypeImpl#getDescriptionRef <em>Description Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FunctionInstanceTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FunctionInstanceTypeImpl#getTypeIDRef <em>Type ID Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.FunctionInstanceTypeImpl#getUniqueID <em>Unique ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionInstanceTypeImpl extends EObjectImpl implements FunctionInstanceType {
	...
	/**
	 * The default value of the '{@link #getTypeIDRef() <em>Type ID Ref</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getTypeIDRef()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getTypeIDRef() <em>Type ID Ref</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getTypeIDRef()
	 * @generated
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.FUNCTION_INSTANCE_TYPE__NAME, oldName, name));
	}
	...
	public void setTypeIDRef(String newTypeIDRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.FUNCTION_INSTANCE_TYPE__TYPE_ID_REF, oldTypeIDRef, typeIDRef));
	}
	...
	public void setUniqueID(String newUniqueID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.FUNCTION_INSTANCE_TYPE__UNIQUE_ID, oldUniqueID, uniqueID));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case XDDPackage.FUNCTION_INSTANCE_TYPE__TYPE_ID_REF:
				return TYPE_ID_REF_EDEFAULT == null ? typeIDRef != null : !TYPE_ID_REF_EDEFAULT.equals(typeIDRef);
			case XDDPackage.FUNCTION_INSTANCE_TYPE__UNIQUE_ID:
