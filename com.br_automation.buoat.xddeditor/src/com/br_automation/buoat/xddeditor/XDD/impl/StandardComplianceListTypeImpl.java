...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Standard Compliance List Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.StandardComplianceListTypeImpl#getCompliantWith <em>Compliant With</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StandardComplianceListTypeImpl extends EObjectImpl implements StandardComplianceListType {
	/**
	 * The cached value of the '{@link #getCompliantWith() <em>Compliant With</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<CompliantWithType> getCompliantWith() {
		if (compliantWith == null) {
			compliantWith = new EObjectContainmentEList<CompliantWithType>(CompliantWithType.class, this, XDDPackage.STANDARD_COMPLIANCE_LIST_TYPE__COMPLIANT_WITH);
		}
