 ...
 * <em><b>ISO15745 Profile Type</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link com.br_automation.buoat.xddeditor.XDD.impl.ISO15745ProfileTypeImpl#getProfileHeader
 * <em>Profile Header</em>}</li>
 * <li>
 * {@link com.br_automation.buoat.xddeditor.XDD.impl.ISO15745ProfileTypeImpl#getProfileBody
 * <em>Profile Body</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class ISO15745ProfileTypeImpl extends EObjectImpl implements ISO15745ProfileType {
    /**
     * The cached value of the '{@link #getProfileHeader()
     * <em>Profile Header</em>}' containment reference. <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The cached value of the '{@link #getProfileBody() <em>Profile Body</em>}'
     ...
     * @generated
     */
    public NotificationChain basicSetProfileHeader(ProfileHeaderDataType newProfileHeader,
        NotificationChain msgs) {
        ProfileHeaderDataType oldProfileHeader = profileHeader;
        profileHeader = newProfileHeader;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                XDDPackage.ISO15745_PROFILE_TYPE__PROFILE_HEADER, oldProfileHeader,
                newProfileHeader);
            if (msgs == null)
                msgs = notification;
            else
    ...
    public void setProfileHeader(ProfileHeaderDataType newProfileHeader) {
        if (newProfileHeader != profileHeader) {
            ...
            if (profileHeader != null)
                msgs = ((InternalEObject) profileHeader).eInverseRemove(
                    this,
                    EOPPOSITE_FEATURE_BASE - XDDPackage.ISO15745_PROFILE_TYPE__PROFILE_HEADER,
                    null, msgs);
            if (newProfileHeader != null)
                msgs = ((InternalEObject) newProfileHeader).eInverseAdd(
                    this,
                    EOPPOSITE_FEATURE_BASE - XDDPackage.ISO15745_PROFILE_TYPE__PROFILE_HEADER,
                    null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                XDDPackage.ISO15745_PROFILE_TYPE__PROFILE_HEADER, newProfileHeader,
                newProfileHeader));
    }
     ...
     * @generated
     */
    public NotificationChain basicSetProfileBody(ProfileBodyDataType newProfileBody,
        NotificationChain msgs) {
        ProfileBodyDataType oldProfileBody = profileBody;
        profileBody = newProfileBody;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                XDDPackage.ISO15745_PROFILE_TYPE__PROFILE_BODY, oldProfileBody, newProfileBody);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
    ...
    public void setProfileBody(ProfileBodyDataType newProfileBody) {
        if (newProfileBody != profileBody) {
            NotificationChain msgs = null;
            if (profileBody != null)
                msgs = ((InternalEObject) profileBody).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                    - XDDPackage.ISO15745_PROFILE_TYPE__PROFILE_BODY, null, msgs);
            if (newProfileBody != null)
                msgs = ((InternalEObject) newProfileBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
                    - XDDPackage.ISO15745_PROFILE_TYPE__PROFILE_BODY, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                XDDPackage.ISO15745_PROFILE_TYPE__PROFILE_BODY, newProfileBody, newProfileBody));
    }
