...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Profile Body Device Powerlink</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProfileBodyDevicePowerlinkImpl#getDeviceIdentity <em>Device Identity</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProfileBodyDevicePowerlinkImpl#getDeviceManager <em>Device Manager</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProfileBodyDevicePowerlinkImpl#getDeviceFunction <em>Device Function</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProfileBodyDevicePowerlinkImpl#getApplicationProcess <em>Application Process</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProfileBodyDevicePowerlinkImpl#getExternalProfileHandle <em>External Profile Handle</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProfileBodyDevicePowerlinkImpl#getDeviceClass <em>Device Class</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ProfileBodyDevicePowerlinkImpl#getSpecificationVersion <em>Specification Version</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProfileBodyDevicePowerlinkImpl extends ProfileBodyDataTypeImpl implements ProfileBodyDevicePowerlink {
	/**
	 * The cached value of the '{@link #getDeviceIdentity() <em>Device Identity</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getDeviceManager() <em>Device Manager</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getDeviceFunction() <em>Device Function</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getApplicationProcess() <em>Application Process</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDeviceIdentity(TDeviceIdentity newDeviceIdentity, NotificationChain msgs) {
		TDeviceIdentity oldDeviceIdentity = deviceIdentity;
		deviceIdentity = newDeviceIdentity;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.PROFILE_BODY_DEVICE_POWERLINK__DEVICE_IDENTITY, oldDeviceIdentity, newDeviceIdentity);
	...
	public void setDeviceIdentity(TDeviceIdentity newDeviceIdentity) {
		if (newDeviceIdentity != deviceIdentity) {
			...
			if (deviceIdentity != null)
				msgs = ((InternalEObject)deviceIdentity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDDPackage.PROFILE_BODY_DEVICE_POWERLINK__DEVICE_IDENTITY, null, msgs);
			if (newDeviceIdentity != null)
				msgs = ((InternalEObject)newDeviceIdentity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDDPackage.PROFILE_BODY_DEVICE_POWERLINK__DEVICE_IDENTITY, null, msgs);
			msgs = basicSetDeviceIdentity(newDeviceIdentity, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.PROFILE_BODY_DEVICE_POWERLINK__DEVICE_IDENTITY, newDeviceIdentity, newDeviceIdentity));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDeviceManager(TDeviceManager newDeviceManager, NotificationChain msgs) {
		TDeviceManager oldDeviceManager = deviceManager;
		deviceManager = newDeviceManager;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.PROFILE_BODY_DEVICE_POWERLINK__DEVICE_MANAGER, oldDeviceManager, newDeviceManager);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDeviceManager(TDeviceManager newDeviceManager) {
		if (newDeviceManager != deviceManager) {
			...
			if (deviceManager != null)
				msgs = ((InternalEObject)deviceManager).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDDPackage.PROFILE_BODY_DEVICE_POWERLINK__DEVICE_MANAGER, null, msgs);
			if (newDeviceManager != null)
				msgs = ((InternalEObject)newDeviceManager).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDDPackage.PROFILE_BODY_DEVICE_POWERLINK__DEVICE_MANAGER, null, msgs);
			msgs = basicSetDeviceManager(newDeviceManager, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.PROFILE_BODY_DEVICE_POWERLINK__DEVICE_MANAGER, newDeviceManager, newDeviceManager));
	}
	...
	public EList<TDeviceFunction> getDeviceFunction() {
		if (deviceFunction == null) {
			deviceFunction = new EObjectContainmentEList<TDeviceFunction>(TDeviceFunction.class, this, XDDPackage.PROFILE_BODY_DEVICE_POWERLINK__DEVICE_FUNCTION);
		}
	...
	public EList<TApplicationProcess> getApplicationProcess() {
		if (applicationProcess == null) {
			applicationProcess = new EObjectContainmentEList<TApplicationProcess>(TApplicationProcess.class, this, XDDPackage.PROFILE_BODY_DEVICE_POWERLINK__APPLICATION_PROCESS);
		}
	...
	public EList<ProfileHandleDataType> getExternalProfileHandle() {
		if (externalProfileHandle == null) {
			externalProfileHandle = new EObjectContainmentEList<ProfileHandleDataType>(ProfileHandleDataType.class, this, XDDPackage.PROFILE_BODY_DEVICE_POWERLINK__EXTERNAL_PROFILE_HANDLE);
		}
	...
	public void setDeviceClass(DeviceClassType newDeviceClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.PROFILE_BODY_DEVICE_POWERLINK__DEVICE_CLASS, oldDeviceClass, deviceClass, !oldDeviceClassESet));
	}
	...
	public void unsetDeviceClass() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.PROFILE_BODY_DEVICE_POWERLINK__DEVICE_CLASS, oldDeviceClass, DEVICE_CLASS_EDEFAULT, oldDeviceClassESet));
	}
	...
	public void setSpecificationVersion(TSpecificationVersion newSpecificationVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.PROFILE_BODY_DEVICE_POWERLINK__SPECIFICATION_VERSION, oldSpecificationVersion, specificationVersion, !oldSpecificationVersionESet));
	}
	...
	public void unsetSpecificationVersion() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.PROFILE_BODY_DEVICE_POWERLINK__SPECIFICATION_VERSION, oldSpecificationVersion, SPECIFICATION_VERSION_EDEFAULT, oldSpecificationVersionESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case XDDPackage.PROFILE_BODY_DEVICE_POWERLINK__SPECIFICATION_VERSION:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case XDDPackage.PROFILE_BODY_DEVICE_POWERLINK__APPLICATION_PROCESS:
				...
				getApplicationProcess().addAll((Collection<? extends TApplicationProcess>)newValue);
				return;
			case XDDPackage.PROFILE_BODY_DEVICE_POWERLINK__EXTERNAL_PROFILE_HANDLE:
