...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Data Type List Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.DataTypeListTypeImpl#getDefType <em>Def Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataTypeListTypeImpl extends EObjectImpl implements DataTypeListType {
	/**
	 * The cached value of the '{@link #getDefType() <em>Def Type</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getDefType()
	 * @generated
	...
	public EList<TDataTypes> getDefType() {
		if (defType == null) {
			defType = new EObjectContainmentEList<TDataTypes>(TDataTypes.class, this, XDDPackage.DATA_TYPE_LIST_TYPE__DEF_TYPE);
		}
		return defType;
	}
