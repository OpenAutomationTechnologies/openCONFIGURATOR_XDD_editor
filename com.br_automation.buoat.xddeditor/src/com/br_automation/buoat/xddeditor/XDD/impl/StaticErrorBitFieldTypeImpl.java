 ...
 * <ul>
 * <li>
 * {@link com.br_automation.buoat.xddeditor.XDD.impl.StaticErrorBitFieldTypeImpl#getErrorBit
 * <em>Error Bit</em>}</li>
 * </ul>
 * </p>
 * 
...
public class StaticErrorBitFieldTypeImpl extends EObjectImpl implements StaticErrorBitFieldType {
    /**
     * The cached value of the '{@link #getErrorBit() <em>Error Bit</em>}'
    ...
    public EList<ErrorBitDataType> getErrorBit() {
        if (errorBit == null) {
            errorBit = new EObjectContainmentEList<ErrorBitDataType>(ErrorBitDataType.class, this,
                XDDPackage.STATIC_ERROR_BIT_FIELD_TYPE__ERROR_BIT);
        }
        return errorBit;
    }
