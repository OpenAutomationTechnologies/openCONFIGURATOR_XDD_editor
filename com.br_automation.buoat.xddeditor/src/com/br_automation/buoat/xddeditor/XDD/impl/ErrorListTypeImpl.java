 ...
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ErrorListTypeImpl#getError <em>Error</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ErrorListTypeImpl extends EObjectImpl implements ErrorListType {
	...
	public EList<ErrorConstantDataType> getError() {
		if (error == null) {
			error = new EObjectContainmentEList<ErrorConstantDataType>(ErrorConstantDataType.class, this, XDDPackage.ERROR_LIST_TYPE__ERROR);
		}
		return error;
	}
