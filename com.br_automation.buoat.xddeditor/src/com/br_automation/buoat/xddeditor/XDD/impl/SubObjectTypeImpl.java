...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sub Object Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.SubObjectTypeImpl#getAccessType <em>Access Type</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.SubObjectTypeImpl#getActualValue <em>Actual Value</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.SubObjectTypeImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.SubObjectTypeImpl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.SubObjectTypeImpl#getDenotation <em>Denotation</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.SubObjectTypeImpl#getHighLimit <em>High Limit</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.SubObjectTypeImpl#getLowLimit <em>Low Limit</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.SubObjectTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.SubObjectTypeImpl#getObjectType <em>Object Type</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.SubObjectTypeImpl#getObjFlags <em>Obj Flags</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.SubObjectTypeImpl#getPDOmapping <em>PD Omapping</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.SubObjectTypeImpl#getSubIndex <em>Sub Index</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.SubObjectTypeImpl#getUniqueIDRef <em>Unique ID Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubObjectTypeImpl extends EObjectImpl implements SubObjectType {
	...
	public void setAccessType(TObjectAccessType newAccessType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.SUB_OBJECT_TYPE__ACCESS_TYPE, oldAccessType, accessType, !oldAccessTypeESet));
	}
	...
	public void unsetAccessType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.SUB_OBJECT_TYPE__ACCESS_TYPE, oldAccessType, ACCESS_TYPE_EDEFAULT, oldAccessTypeESet));
	}
	...
	public void setActualValue(String newActualValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.SUB_OBJECT_TYPE__ACTUAL_VALUE, oldActualValue, actualValue));
	}
	...
	public void setDataType(byte[] newDataType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.SUB_OBJECT_TYPE__DATA_TYPE, oldDataType, dataType));
	}
	...
	public void setDefaultValue(String newDefaultValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.SUB_OBJECT_TYPE__DEFAULT_VALUE, oldDefaultValue, defaultValue));
	}
	...
	public void setDenotation(String newDenotation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.SUB_OBJECT_TYPE__DENOTATION, oldDenotation, denotation));
	}
	...
	public void setHighLimit(String newHighLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.SUB_OBJECT_TYPE__HIGH_LIMIT, oldHighLimit, highLimit));
	}
	...
	public void setLowLimit(String newLowLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.SUB_OBJECT_TYPE__LOW_LIMIT, oldLowLimit, lowLimit));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.SUB_OBJECT_TYPE__NAME, oldName, name));
	}
	...
	public void setObjectType(short newObjectType) {
		...
		objectTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.SUB_OBJECT_TYPE__OBJECT_TYPE, oldObjectType, objectType, !oldObjectTypeESet));
	}
	...
	public void unsetObjectType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.SUB_OBJECT_TYPE__OBJECT_TYPE, oldObjectType, OBJECT_TYPE_EDEFAULT, oldObjectTypeESet));
	}
	...
	public void setObjFlags(byte[] newObjFlags) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.SUB_OBJECT_TYPE__OBJ_FLAGS, oldObjFlags, objFlags));
	}
	...
	public void setPDOmapping(TObjectPDOMapping newPDOmapping) {
		...
		pDOmappingESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.SUB_OBJECT_TYPE__PD_OMAPPING, oldPDOmapping, pDOmapping, !oldPDOmappingESet));
	}
	...
	public void unsetPDOmapping() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.SUB_OBJECT_TYPE__PD_OMAPPING, oldPDOmapping, PD_OMAPPING_EDEFAULT, oldPDOmappingESet));
	}
	...
	public void setSubIndex(byte[] newSubIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.SUB_OBJECT_TYPE__SUB_INDEX, oldSubIndex, subIndex));
	}
	...
	public void setUniqueIDRef(String newUniqueIDRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.SUB_OBJECT_TYPE__UNIQUE_ID_REF, oldUniqueIDRef, uniqueIDRef));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case XDDPackage.SUB_OBJECT_TYPE__SUB_INDEX:
				return SUB_INDEX_EDEFAULT == null ? subIndex != null : !SUB_INDEX_EDEFAULT.equals(subIndex);
			case XDDPackage.SUB_OBJECT_TYPE__UNIQUE_ID_REF:
