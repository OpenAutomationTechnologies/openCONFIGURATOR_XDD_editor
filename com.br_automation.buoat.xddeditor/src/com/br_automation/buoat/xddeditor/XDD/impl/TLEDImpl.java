...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TLED</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TLEDImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TLEDImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TLEDImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TLEDImpl#getLabelRef <em>Label Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TLEDImpl#getDescriptionRef <em>Description Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TLEDImpl#getLEDstate <em>LE Dstate</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TLEDImpl#getLEDcolors <em>LE Dcolors</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TLEDImpl#getLEDtype <em>LE Dtype</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TLEDImpl extends EObjectImpl implements TLED {
	...
	/**
	 * The cached value of the '{@link #getLEDstate() <em>LE Dstate</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getLEDstate()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getLEDcolors() <em>LE Dcolors</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getLEDcolors()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getLEDcolors() <em>LE Dcolors</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getLEDcolors()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getLEDtype() <em>LE Dtype</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getLEDtype()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getLEDtype() <em>LE Dtype</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getLEDtype()
	 * @generated
	...
	/**
	 * This is true if the LE Dtype attribute has been set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	...
	public void setLEDcolors(LEDcolorsType newLEDcolors) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TLED__LE_DCOLORS, oldLEDcolors, lEDcolors, !oldLEDcolorsESet));
	}
	...
	public void unsetLEDcolors() {
		...
		lEDcolorsESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TLED__LE_DCOLORS, oldLEDcolors, LE_DCOLORS_EDEFAULT, oldLEDcolorsESet));
	}
	...
	public void setLEDtype(LEDtypeType newLEDtype) {
		...
		lEDtypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TLED__LE_DTYPE, oldLEDtype, lEDtype, !oldLEDtypeESet));
	}
	...
	public void unsetLEDtype() {
		...
		lEDtypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TLED__LE_DTYPE, oldLEDtype, LE_DTYPE_EDEFAULT, oldLEDtypeESet));
	}
	...
	public String toString() {
		...
		if (lEDcolorsESet) result.append(lEDcolors); else result.append("<unset>");
		result.append(", lEDtype: ");
		if (lEDtypeESet) result.append(lEDtype); else result.append("<unset>");
		result.append(')');
