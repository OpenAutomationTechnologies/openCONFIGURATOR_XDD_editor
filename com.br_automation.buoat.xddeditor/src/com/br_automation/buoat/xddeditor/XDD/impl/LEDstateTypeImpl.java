...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>LE Dstate Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.LEDstateTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.LEDstateTypeImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.LEDstateTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.LEDstateTypeImpl#getLabelRef <em>Label Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.LEDstateTypeImpl#getDescriptionRef <em>Description Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.LEDstateTypeImpl#getFlashingPeriod <em>Flashing Period</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.LEDstateTypeImpl#getImpulsWidth <em>Impuls Width</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.LEDstateTypeImpl#getLEDcolor <em>LE Dcolor</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.LEDstateTypeImpl#getNumberOfImpulses <em>Number Of Impulses</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.LEDstateTypeImpl#getState <em>State</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.LEDstateTypeImpl#getUniqueID <em>Unique ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LEDstateTypeImpl extends EObjectImpl implements LEDstateType {
	...
	/**
	 * The default value of the '{@link #getFlashingPeriod() <em>Flashing Period</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getFlashingPeriod() <em>Flashing Period</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getFlashingPeriod()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getImpulsWidth() <em>Impuls Width</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getImpulsWidth()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getImpulsWidth() <em>Impuls Width</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getImpulsWidth()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getLEDcolor() <em>LE Dcolor</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getLEDcolor()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getLEDcolor() <em>LE Dcolor</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getLEDcolor()
	 * @generated
	...
	/**
	 * This is true if the LE Dcolor attribute has been set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	...
	/**
	 * The default value of the '{@link #getNumberOfImpulses() <em>Number Of Impulses</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getNumberOfImpulses() <em>Number Of Impulses</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getNumberOfImpulses()
	 * @generated
	...
	public void setFlashingPeriod(long newFlashingPeriod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.LE_DSTATE_TYPE__FLASHING_PERIOD, oldFlashingPeriod, flashingPeriod, !oldFlashingPeriodESet));
	}
	...
	public void unsetFlashingPeriod() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.LE_DSTATE_TYPE__FLASHING_PERIOD, oldFlashingPeriod, FLASHING_PERIOD_EDEFAULT, oldFlashingPeriodESet));
	}
	...
	public void setImpulsWidth(short newImpulsWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.LE_DSTATE_TYPE__IMPULS_WIDTH, oldImpulsWidth, impulsWidth, !oldImpulsWidthESet));
	}
	...
	public void unsetImpulsWidth() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.LE_DSTATE_TYPE__IMPULS_WIDTH, oldImpulsWidth, IMPULS_WIDTH_EDEFAULT, oldImpulsWidthESet));
	}
	...
	public void setLEDcolor(LEDcolorType newLEDcolor) {
		...
		lEDcolorESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.LE_DSTATE_TYPE__LE_DCOLOR, oldLEDcolor, lEDcolor, !oldLEDcolorESet));
	}
	...
	public void unsetLEDcolor() {
		...
		lEDcolorESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.LE_DSTATE_TYPE__LE_DCOLOR, oldLEDcolor, LE_DCOLOR_EDEFAULT, oldLEDcolorESet));
	}
	...
	public void setNumberOfImpulses(short newNumberOfImpulses) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.LE_DSTATE_TYPE__NUMBER_OF_IMPULSES, oldNumberOfImpulses, numberOfImpulses, !oldNumberOfImpulsesESet));
	}
	...
	public void unsetNumberOfImpulses() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.LE_DSTATE_TYPE__NUMBER_OF_IMPULSES, oldNumberOfImpulses, NUMBER_OF_IMPULSES_EDEFAULT, oldNumberOfImpulsesESet));
	}
	...
	public void setState(StateType newState) {
		...
		stateESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.LE_DSTATE_TYPE__STATE, oldState, state, !oldStateESet));
	}
	...
	public void unsetState() {
		...
		stateESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.LE_DSTATE_TYPE__STATE, oldState, STATE_EDEFAULT, oldStateESet));
	}
	...
	public void setUniqueID(String newUniqueID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.LE_DSTATE_TYPE__UNIQUE_ID, oldUniqueID, uniqueID));
	}
	...
	public String toString() {
		...
		if (flashingPeriodESet) result.append(flashingPeriod); else result.append("<unset>");
		result.append(", impulsWidth: ");
		if (impulsWidthESet) result.append(impulsWidth); else result.append("<unset>");
		result.append(", lEDcolor: ");
		if (lEDcolorESet) result.append(lEDcolor); else result.append("<unset>");
		result.append(", numberOfImpulses: ");
		if (numberOfImpulsesESet) result.append(numberOfImpulses); else result.append("<unset>");
		result.append(", state: ");
