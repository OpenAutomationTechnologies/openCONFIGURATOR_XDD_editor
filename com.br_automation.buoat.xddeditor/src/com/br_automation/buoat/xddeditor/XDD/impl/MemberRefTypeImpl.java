 ...
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.MemberRefTypeImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.MemberRefTypeImpl#getUniqueIDRef <em>Unique ID Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MemberRefTypeImpl extends EObjectImpl implements MemberRefType {
	...
	public void setIndex(long newIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.MEMBER_REF_TYPE__INDEX, oldIndex, index, !oldIndexESet));
	}
	...
	public void unsetIndex() {
		...
		indexESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.MEMBER_REF_TYPE__INDEX, oldIndex, INDEX_EDEFAULT, oldIndexESet));
	}
	...
	public void setUniqueIDRef(String newUniqueIDRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.MEMBER_REF_TYPE__UNIQUE_ID_REF, oldUniqueIDRef, uniqueIDRef));
	}
