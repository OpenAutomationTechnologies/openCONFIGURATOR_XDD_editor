...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TDevice Identity</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDeviceIdentityImpl#getVendorName <em>Vendor Name</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDeviceIdentityImpl#getVendorID <em>Vendor ID</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDeviceIdentityImpl#getVendorText <em>Vendor Text</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDeviceIdentityImpl#getDeviceFamily <em>Device Family</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDeviceIdentityImpl#getProductFamily <em>Product Family</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDeviceIdentityImpl#getProductName <em>Product Name</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDeviceIdentityImpl#getProductID <em>Product ID</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDeviceIdentityImpl#getProductText <em>Product Text</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDeviceIdentityImpl#getOrderNumber <em>Order Number</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDeviceIdentityImpl#getVersion <em>Version</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDeviceIdentityImpl#getBuildDate <em>Build Date</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDeviceIdentityImpl#getSpecificationRevision <em>Specification Revision</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TDeviceIdentityImpl#getInstanceName <em>Instance Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TDeviceIdentityImpl extends EObjectImpl implements TDeviceIdentity {
	/**
	 * The cached value of the '{@link #getVendorName() <em>Vendor Name</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getVendorName()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getVendorText() <em>Vendor Text</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getVendorText()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getProductFamily() <em>Product Family</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getProductText() <em>Product Text</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getProductText()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getOrderNumber() <em>Order Number</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getOrderNumber()
	 * @generated
	 ...
	 * @generated
	 */
	public NotificationChain basicSetVendorName(VendorNameType newVendorName, NotificationChain msgs) {
		VendorNameType oldVendorName = vendorName;
		vendorName = newVendorName;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_IDENTITY__VENDOR_NAME, oldVendorName, newVendorName);
	...
	public void setVendorName(VendorNameType newVendorName) {
		if (newVendorName != vendorName) {
			...
			if (vendorName != null)
				msgs = ((InternalEObject)vendorName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_IDENTITY__VENDOR_NAME, null, msgs);
			if (newVendorName != null)
				msgs = ((InternalEObject)newVendorName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_IDENTITY__VENDOR_NAME, null, msgs);
			msgs = basicSetVendorName(newVendorName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_IDENTITY__VENDOR_NAME, newVendorName, newVendorName));
	}
	...
	public NotificationChain basicSetVendorID(TVendorID newVendorID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_IDENTITY__VENDOR_ID, oldVendorID, newVendorID);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorID(TVendorID newVendorID) {
		if (newVendorID != vendorID) {
			NotificationChain msgs = null;
			if (vendorID != null)
				msgs = ((InternalEObject)vendorID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_IDENTITY__VENDOR_ID, null, msgs);
			if (newVendorID != null)
				msgs = ((InternalEObject)newVendorID).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_IDENTITY__VENDOR_ID, null, msgs);
			msgs = basicSetVendorID(newVendorID, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_IDENTITY__VENDOR_ID, newVendorID, newVendorID));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetVendorText(VendorTextType newVendorText, NotificationChain msgs) {
		VendorTextType oldVendorText = vendorText;
		vendorText = newVendorText;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_IDENTITY__VENDOR_TEXT, oldVendorText, newVendorText);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setVendorText(VendorTextType newVendorText) {
		if (newVendorText != vendorText) {
			NotificationChain msgs = null;
			if (vendorText != null)
				msgs = ((InternalEObject)vendorText).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_IDENTITY__VENDOR_TEXT, null, msgs);
			if (newVendorText != null)
				msgs = ((InternalEObject)newVendorText).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_IDENTITY__VENDOR_TEXT, null, msgs);
			msgs = basicSetVendorText(newVendorText, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_IDENTITY__VENDOR_TEXT, newVendorText, newVendorText));
	}
	...
	public NotificationChain basicSetDeviceFamily(TDeviceFamily newDeviceFamily, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_IDENTITY__DEVICE_FAMILY, oldDeviceFamily, newDeviceFamily);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDeviceFamily(TDeviceFamily newDeviceFamily) {
		if (newDeviceFamily != deviceFamily) {
			...
			if (deviceFamily != null)
				msgs = ((InternalEObject)deviceFamily).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_IDENTITY__DEVICE_FAMILY, null, msgs);
			if (newDeviceFamily != null)
				msgs = ((InternalEObject)newDeviceFamily).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_IDENTITY__DEVICE_FAMILY, null, msgs);
			msgs = basicSetDeviceFamily(newDeviceFamily, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_IDENTITY__DEVICE_FAMILY, newDeviceFamily, newDeviceFamily));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetProductFamily(ProductFamilyType newProductFamily, NotificationChain msgs) {
		ProductFamilyType oldProductFamily = productFamily;
		productFamily = newProductFamily;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_IDENTITY__PRODUCT_FAMILY, oldProductFamily, newProductFamily);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProductFamily(ProductFamilyType newProductFamily) {
		if (newProductFamily != productFamily) {
			...
			if (productFamily != null)
				msgs = ((InternalEObject)productFamily).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_IDENTITY__PRODUCT_FAMILY, null, msgs);
			if (newProductFamily != null)
				msgs = ((InternalEObject)newProductFamily).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_IDENTITY__PRODUCT_FAMILY, null, msgs);
			msgs = basicSetProductFamily(newProductFamily, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_IDENTITY__PRODUCT_FAMILY, newProductFamily, newProductFamily));
	}
	...
	public NotificationChain basicSetProductName(ProductNameType newProductName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_IDENTITY__PRODUCT_NAME, oldProductName, newProductName);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProductName(ProductNameType newProductName) {
		if (newProductName != productName) {
			NotificationChain msgs = null;
			if (productName != null)
				msgs = ((InternalEObject)productName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_IDENTITY__PRODUCT_NAME, null, msgs);
			if (newProductName != null)
				msgs = ((InternalEObject)newProductName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_IDENTITY__PRODUCT_NAME, null, msgs);
			msgs = basicSetProductName(newProductName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_IDENTITY__PRODUCT_NAME, newProductName, newProductName));
	}
	...
	public NotificationChain basicSetProductID(TProductID newProductID, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_IDENTITY__PRODUCT_ID, oldProductID, newProductID);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProductID(TProductID newProductID) {
		if (newProductID != productID) {
			NotificationChain msgs = null;
			if (productID != null)
				msgs = ((InternalEObject)productID).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_IDENTITY__PRODUCT_ID, null, msgs);
			if (newProductID != null)
				msgs = ((InternalEObject)newProductID).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_IDENTITY__PRODUCT_ID, null, msgs);
			msgs = basicSetProductID(newProductID, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_IDENTITY__PRODUCT_ID, newProductID, newProductID));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetProductText(ProductTextType newProductText, NotificationChain msgs) {
		ProductTextType oldProductText = productText;
		productText = newProductText;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_IDENTITY__PRODUCT_TEXT, oldProductText, newProductText);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProductText(ProductTextType newProductText) {
		if (newProductText != productText) {
			NotificationChain msgs = null;
			if (productText != null)
				msgs = ((InternalEObject)productText).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_IDENTITY__PRODUCT_TEXT, null, msgs);
			if (newProductText != null)
				msgs = ((InternalEObject)newProductText).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_IDENTITY__PRODUCT_TEXT, null, msgs);
			msgs = basicSetProductText(newProductText, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_IDENTITY__PRODUCT_TEXT, newProductText, newProductText));
	}
	...
	public EList<OrderNumberType> getOrderNumber() {
		if (orderNumber == null) {
			orderNumber = new EObjectContainmentEList<OrderNumberType>(OrderNumberType.class, this, XDDPackage.TDEVICE_IDENTITY__ORDER_NUMBER);
		}
		return orderNumber;
	}
	...
	public EList<TVersion> getVersion() {
		if (version == null) {
			version = new EObjectContainmentEList<TVersion>(TVersion.class, this, XDDPackage.TDEVICE_IDENTITY__VERSION);
		}
		return version;
	}
	...
	public void setBuildDate(XMLGregorianCalendar newBuildDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_IDENTITY__BUILD_DATE, oldBuildDate, buildDate));
	}
	...
	public NotificationChain basicSetSpecificationRevision(TSpecificationRevision newSpecificationRevision, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_IDENTITY__SPECIFICATION_REVISION, oldSpecificationRevision, newSpecificationRevision);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSpecificationRevision(TSpecificationRevision newSpecificationRevision) {
		if (newSpecificationRevision != specificationRevision) {
			...
			if (specificationRevision != null)
				msgs = ((InternalEObject)specificationRevision).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_IDENTITY__SPECIFICATION_REVISION, null, msgs);
			if (newSpecificationRevision != null)
				msgs = ((InternalEObject)newSpecificationRevision).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_IDENTITY__SPECIFICATION_REVISION, null, msgs);
			msgs = basicSetSpecificationRevision(newSpecificationRevision, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_IDENTITY__SPECIFICATION_REVISION, newSpecificationRevision, newSpecificationRevision));
	}
	...
	public NotificationChain basicSetInstanceName(InstanceNameType newInstanceName, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_IDENTITY__INSTANCE_NAME, oldInstanceName, newInstanceName);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setInstanceName(InstanceNameType newInstanceName) {
		if (newInstanceName != instanceName) {
			...
			if (instanceName != null)
				msgs = ((InternalEObject)instanceName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_IDENTITY__INSTANCE_NAME, null, msgs);
			if (newInstanceName != null)
				msgs = ((InternalEObject)newInstanceName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TDEVICE_IDENTITY__INSTANCE_NAME, null, msgs);
			msgs = basicSetInstanceName(newInstanceName, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TDEVICE_IDENTITY__INSTANCE_NAME, newInstanceName, newInstanceName));
	}
