...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TAllowed Values Template</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TAllowedValuesTemplateImpl#getValue <em>Value</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TAllowedValuesTemplateImpl#getRange <em>Range</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TAllowedValuesTemplateImpl#getUniqueID <em>Unique ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TAllowedValuesTemplateImpl extends EObjectImpl implements TAllowedValuesTemplate {
	...
	public EList<TValue> getValue() {
		if (value == null) {
			value = new EObjectContainmentEList<TValue>(TValue.class, this, XDDPackage.TALLOWED_VALUES_TEMPLATE__VALUE);
		}
		return value;
	}
	...
	public EList<TRange> getRange() {
		if (range == null) {
			range = new EObjectContainmentEList<TRange>(TRange.class, this, XDDPackage.TALLOWED_VALUES_TEMPLATE__RANGE);
		}
		return range;
	}
	...
	public void setUniqueID(String newUniqueID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TALLOWED_VALUES_TEMPLATE__UNIQUE_ID, oldUniqueID, uniqueID));
	}
