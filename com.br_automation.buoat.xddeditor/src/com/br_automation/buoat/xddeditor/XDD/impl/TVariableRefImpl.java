...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TVariable Ref</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TVariableRefImpl#getInstanceIDRef <em>Instance ID Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TVariableRefImpl#getVariableIDRef <em>Variable ID Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TVariableRefImpl#getMemberRef <em>Member Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TVariableRefImpl#getPosition <em>Position</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TVariableRefImpl extends EObjectImpl implements TVariableRef {
	/**
	 * The cached value of the '{@link #getInstanceIDRef() <em>Instance ID Ref</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getVariableIDRef() <em>Variable ID Ref</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<InstanceIDRefType> getInstanceIDRef() {
		if (instanceIDRef == null) {
			instanceIDRef = new EObjectContainmentEList<InstanceIDRefType>(InstanceIDRefType.class, this, XDDPackage.TVARIABLE_REF__INSTANCE_ID_REF);
		}
	...
	public NotificationChain basicSetVariableIDRef(VariableIDRefType newVariableIDRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XDDPackage.TVARIABLE_REF__VARIABLE_ID_REF, oldVariableIDRef, newVariableIDRef);
	...
	public void setVariableIDRef(VariableIDRefType newVariableIDRef) {
		if (newVariableIDRef != variableIDRef) {
			...
			if (variableIDRef != null)
				msgs = ((InternalEObject)variableIDRef).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TVARIABLE_REF__VARIABLE_ID_REF, null, msgs);
			if (newVariableIDRef != null)
				msgs = ((InternalEObject)newVariableIDRef).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XDDPackage.TVARIABLE_REF__VARIABLE_ID_REF, null, msgs);
			msgs = basicSetVariableIDRef(newVariableIDRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TVARIABLE_REF__VARIABLE_ID_REF, newVariableIDRef, newVariableIDRef));
	}
	...
	public EList<MemberRefType> getMemberRef() {
		if (memberRef == null) {
			memberRef = new EObjectContainmentEList<MemberRefType>(MemberRefType.class, this, XDDPackage.TVARIABLE_REF__MEMBER_REF);
		}
		return memberRef;
	}
	...
	public void setPosition(short newPosition) {
		...
		positionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TVARIABLE_REF__POSITION, oldPosition, position, !oldPositionESet));
	}
	...
	public void unsetPosition() {
		...
		positionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TVARIABLE_REF__POSITION, oldPosition, POSITION_EDEFAULT, oldPositionESet));
	}
