...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Error Constant Data Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ErrorConstantDataTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ErrorConstantDataTypeImpl#getLabel <em>Label</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ErrorConstantDataTypeImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ErrorConstantDataTypeImpl#getLabelRef <em>Label Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ErrorConstantDataTypeImpl#getDescriptionRef <em>Description Ref</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ErrorConstantDataTypeImpl#getAddInfo <em>Add Info</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ErrorConstantDataTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.ErrorConstantDataTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ErrorConstantDataTypeImpl extends EObjectImpl implements ErrorConstantDataType {
	...
	/**
	 * The cached value of the '{@link #getAddInfo() <em>Add Info</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAddInfo()
	 * @generated
	...
	public EList<AddInfoType> getAddInfo() {
		if (addInfo == null) {
			addInfo = new EObjectContainmentEList<AddInfoType>(AddInfoType.class, this, XDDPackage.ERROR_CONSTANT_DATA_TYPE__ADD_INFO);
		}
		return addInfo;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.ERROR_CONSTANT_DATA_TYPE__NAME, oldName, name));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.ERROR_CONSTANT_DATA_TYPE__VALUE, oldValue, value));
	}
