...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TFunction Instance List</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TFunctionInstanceListImpl#getFunctionInstance <em>Function Instance</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TFunctionInstanceListImpl#getConnection <em>Connection</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TFunctionInstanceListImpl extends EObjectImpl implements TFunctionInstanceList {
	/**
	 * The cached value of the '{@link #getFunctionInstance() <em>Function Instance</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<FunctionInstanceType> getFunctionInstance() {
		if (functionInstance == null) {
			functionInstance = new EObjectContainmentEList<FunctionInstanceType>(FunctionInstanceType.class, this, XDDPackage.TFUNCTION_INSTANCE_LIST__FUNCTION_INSTANCE);
		}
	...
	public EList<ConnectionType> getConnection() {
		if (connection == null) {
			connection = new EObjectContainmentEList<ConnectionType>(ConnectionType.class, this, XDDPackage.TFUNCTION_INSTANCE_LIST__CONNECTION);
		}
		return connection;
	}
