...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>LE Dstate Ref Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.LEDstateRefTypeImpl#getStateIDRef <em>State ID Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LEDstateRefTypeImpl extends EObjectImpl implements LEDstateRefType {
	/**
	 * The default value of the '{@link #getStateIDRef() <em>State ID Ref</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getStateIDRef()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getStateIDRef() <em>State ID Ref</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getStateIDRef()
	 * @generated
	...
	public void setStateIDRef(String newStateIDRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.LE_DSTATE_REF_TYPE__STATE_ID_REF, oldStateIDRef, stateIDRef));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case XDDPackage.LE_DSTATE_REF_TYPE__STATE_ID_REF:
				return STATE_ID_REF_EDEFAULT == null ? stateIDRef != null : !STATE_ID_REF_EDEFAULT.equals(stateIDRef);
		}
