...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Label Ref Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.LabelRefTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.LabelRefTypeImpl#getDictID <em>Dict ID</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.LabelRefTypeImpl#getTextID <em>Text ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LabelRefTypeImpl extends EObjectImpl implements LabelRefType {
	...
	protected EClass eStaticClass() {
		return XDDPackage.eINSTANCE.getLabelRefType();
	}
	...
	public void setDictID(String newDictID) {
		...
		dictID = newDictID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.LABEL_REF_TYPE__DICT_ID, oldDictID, dictID));
	}
	...
	public void setTextID(String newTextID) {
		...
		textID = newTextID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.LABEL_REF_TYPE__TEXT_ID, oldTextID, textID));
	}
