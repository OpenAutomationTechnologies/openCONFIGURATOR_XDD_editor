...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TVersion</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TVersionImpl#getValue <em>Value</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TVersionImpl#isReadOnly <em>Read Only</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.TVersionImpl#getVersionType <em>Version Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TVersionImpl extends EObjectImpl implements TVersion {
	...
	public void setReadOnly(boolean newReadOnly) {
		...
		readOnlyESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TVERSION__READ_ONLY, oldReadOnly, readOnly, !oldReadOnlyESet));
	}
	...
	public void unsetReadOnly() {
		...
		readOnlyESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TVERSION__READ_ONLY, oldReadOnly, READ_ONLY_EDEFAULT, oldReadOnlyESet));
	}
	...
	public void setVersionType(VersionTypeType newVersionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.TVERSION__VERSION_TYPE, oldVersionType, versionType, !oldVersionTypeESet));
	}
	...
	public void unsetVersionType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, XDDPackage.TVERSION__VERSION_TYPE, oldVersionType, VERSION_TYPE_EDEFAULT, oldVersionTypeESet));
	}
	...
	public String toString() {
		...
		if (versionTypeESet) result.append(versionType); else result.append("<unset>");
		result.append(')');
