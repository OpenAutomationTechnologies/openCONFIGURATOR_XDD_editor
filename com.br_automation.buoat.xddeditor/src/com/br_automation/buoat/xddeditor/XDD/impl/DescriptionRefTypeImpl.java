...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Description Ref Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.DescriptionRefTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.DescriptionRefTypeImpl#getDictID <em>Dict ID</em>}</li>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.impl.DescriptionRefTypeImpl#getTextID <em>Text ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DescriptionRefTypeImpl extends EObjectImpl implements DescriptionRefType {
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.DESCRIPTION_REF_TYPE__VALUE, oldValue, value));
	}
	...
	public void setDictID(String newDictID) {
		...
		dictID = newDictID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.DESCRIPTION_REF_TYPE__DICT_ID, oldDictID, dictID));
	}
	...
	public void setTextID(String newTextID) {
		...
		textID = newTextID;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XDDPackage.DESCRIPTION_REF_TYPE__TEXT_ID, oldTextID, textID));
	}
