...
public interface TCapabilities extends EObject {
    /**
     * Returns the value of the '<em><b>Characteristics List</b></em>'
     * containment reference list. The list contents are of type
     * {@link com.br_automation.buoat.xddeditor.XDD.CharacteristicsListType}.
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Characteristics List</em>' containment
     * reference list isn't clear, there really should be more of a description
     * here...
     * </p>
     * <!-- end-user-doc -->
     * 
     * @return the value of the '<em>Characteristics List</em>' containment
     *         reference list.
     ...
     *        "kind='element' name='characteristicsList' namespace='##targetNamespace'"
     * @generated
     */
    EList<CharacteristicsListType> getCharacteristicsList();

    /**
     * Returns the value of the '<em><b>Standard Compliance List</b></em>'
     * containment reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Standard Compliance List</em>' containment
     * reference isn't clear, there really should be more of a description
     * here...
     * </p>
     * <!-- end-user-doc -->
     * 
     * @return the value of the '<em>Standard Compliance List</em>' containment
     *         reference.
     ...
     *        "kind='element' name='standardComplianceList' namespace='##targetNamespace'"
     * @generated
     */
     ...
     * 
     * @param value
     *            the new value of the '<em>Standard Compliance List</em>'
