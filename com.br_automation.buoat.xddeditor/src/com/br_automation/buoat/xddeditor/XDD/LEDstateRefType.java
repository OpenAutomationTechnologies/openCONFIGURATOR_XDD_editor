...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>LE Dstate Ref Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link com.br_automation.buoat.xddeditor.XDD.LEDstateRefType#getStateIDRef <em>State ID Ref</em>}</li>
 * </ul>
 *
...
public interface LEDstateRefType extends EObject {
	...
	/**
	 * Sets the value of the '{@link com.br_automation.buoat.xddeditor.XDD.LEDstateRefType#getStateIDRef <em>State ID Ref</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>State ID Ref</em>' attribute.
	 * @see #getStateIDRef()
	 * @generated
	 */
