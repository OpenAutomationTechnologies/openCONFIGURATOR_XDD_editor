...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>TObject Access Type</b></em>',
...
public enum TObjectAccessType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final TObjectAccessType[] VALUES_ARRAY =
		new TObjectAccessType[] {
			RO,
			WO,
			RW,
			CONST,
	...
	/**
	 * A public read-only list of all the '<em><b>TObject Access Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<TObjectAccessType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>TObject Access Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the '<em><b>TObject Access Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	...
	/**
	 * Returns the '<em><b>TObject Access Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	private TObjectAccessType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
